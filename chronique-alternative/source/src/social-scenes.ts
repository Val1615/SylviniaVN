...
export const SOCIAL_SCENES: SocialScene[] = [
  ...
  },
  {
    ...
    prompt: [
      ...
      line("Remerii", "Elle a surtout déposé de la boue sur mon tapis. Je doute que le propriétaire accepte cette monnaie."),
      line("Narration", "Medig essuie son bec sur la manche d’Hylee, puis inspecte le bord de son assiette."),
      line("Hylee", "Tu reconnais {player} ? Oui, je sais, tu as surtout reconnu le pain. Attends, je vais ouvrir la fenêtre en grand."),
    ],
    choices: [
      choice("med-r", "Observer ce qui attire l’attention de Medig.", "resonance", [line("Narration", "La chouette suit du regard un morceau de pain. Hylee le déplace à gauche, puis à droite."), line("Remerii", "Une méthodologie contestable."), line("Hylee", "Tu dis ça parce qu’elle a choisi avant toi."), line("Narration", "Medig mordille affectueusement le gant de Remerii, ce qui clôt le débat.")], { trust: 3, confluence: 5, flags: ["medig-window", "story-medig-guide"], relationshipEffects: { remerii: { trust: 3, affection: 2 } } }),
      choice("med-l", "Écarter les notes de Remerii avant que Medig marche dessus.", "lucidite", [line("Remerii", "Enfin une personne qui ne confond pas enthousiasme et absence de précaution."), line("Hylee", "On peut être prudent·es rapidement."), line("Narration", "Vous glissez les notes dans une chemise. Medig examine le rectangle sec qu’elles laissent sur la table, puis choisit la chaise d’Hylee.")], { trust: 4, confluence: 4, flags: ["medig-window", "story-medig-guide"], relationshipEffects: { remerii: { trust: 4 } } }),
      choice("med-a", "Offrir votre bras à Medig pour qu’elle change de perchoir.", "audace", [line("Narration", "Medig regarde votre bras, puis choisit votre tête avec une assurance souveraine."), line("Hylee", "Elle t’aime bien."), line("Remerii", "Ou elle souhaite améliorer votre sens de l’humilité avant la route."), line("Narration", "Hylee approche sa main. Medig descend sur son poignet, et vous pouvez enfin redresser la tête.")], { affection: 3, confluence: 4, flags: ["medig-window", "story-medig-guide"], relationshipEffects: { remerii: { affection: 3 } } }),
    ],
  },
  {
