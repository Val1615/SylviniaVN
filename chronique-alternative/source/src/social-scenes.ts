...
export const SOCIAL_SCENES: SocialScene[] = [
  {
    id: "amanea-family-truth", title: "L’héritière et la frontière", characters: ["amanea", "allenna", "iriana"], triggerCharacters: ["amanea", "allenna"], requiredPresent: ["amanea", "allenna"], minStages: { amanea: 2, allenna: 1 }, excludesFlags: ["amanea-family-truth"], oneTime: true, priority: 110, mood: "thinking",
    prompt: [
      line("Narration", "Dans la salle de guerre d’Akuhn’Nabad, Allenna occupe enfin le siège placé à la droite d’Amanea. Un miroir montre Iriana depuis Al’Gratal ; entre les trois femmes, une carte de la frontière attend une décision commune."),
      line("Allenna", "J’autoriserai un passage civil surveillé. Pas une ambassade impériale, pas des soldats sous un autre nom : des guérisseurs, des familles et les marchandises vérifiées par nos propres équipes."),
      line("Iriana", "L’Empire exigera un sceau. Je peux donner le mien sans réclamer que votre cité le traite comme une permission de vivre."),
      line("Amanea", "Allenna propose une décision que je n’aurais pas prise. C’est précisément pourquoi elle doit pouvoir la défendre sans que mon règne parle à travers sa bouche."),
      line("Narration", "La négociation ne répare aucune famille. Elle montre néanmoins une héritière capable de choisir autrement, une princesse qui limite volontairement son Empire et une reine qui accepte de ne pas posséder la conclusion."),
    ],
    choices: [
      choice("aft-l", "Rendre les limites vérifiables par les deux cités.", "lucidite", [line("{player}", "Deux registres identiques, contrôlés par Allenna et Iriana. Aucun sceau ne peut modifier seul la liste des personnes admises."), line("Allenna", "Une frontière partagée sans souveraineté partagée. Applicable."), line("Amanea", "Et assez contrariante pour empêcher chacun de nous de tricher seul. Adopté.")], { trust: 7, flags: ["amanea-family-truth", "story-family-boundary"], relationshipEffects: { iriana: { trust: 5 }, allenna: { trust: 6 } } }),
      choice("aft-s", "Proposer un essai limité qui peut être interrompu sans représailles.", "sangFroid", [line("{player}", "Trois jours. Chacun peut fermer le passage, mais devra expliquer publiquement pourquoi."), line("Iriana", "Une sortie réelle et un coût politique à l’arbitraire. J’accepte."), line("Allenna", "Moi aussi."), line("Amanea", "Alors ma préférence ne décidera pas à leur place.")], { trust: 8, flags: ["amanea-family-truth", "story-family-boundary"], relationshipEffects: { iriana: { trust: 5 }, allenna: { trust: 6 } } }),
      choice("aft-a", "Demander à Amanea de quitter la table pendant le premier vote.", "audace", [line("Narration", "Le silence devient dangereux. Puis Amanea se lève réellement."), line("Amanea", "Une héritière qui ne peut décider qu’en ma présence n’hérite de rien."), line("Allenna", "Le passage ouvrira. Iriana, asseyez-vous : nous écrivons les règles."), line("Narration", "Amanea s’arrête derrière la porte, assez loin pour ne pas diriger, assez près pour entendre qu’Allenna n’a pas besoin d’elle.")], { affection: 7, trust: 5, flags: ["amanea-family-truth", "story-family-boundary"], relationshipEffects: { iriana: { affection: 4, trust: 3 }, allenna: { affection: 5, trust: 4 } } }),
    ],
  },
  {
