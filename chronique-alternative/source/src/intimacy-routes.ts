  ...
  lineva: [
    {
      ...
      tender: ["Elle vous garde contre elle et couvre votre visage puis vos épaules de baisers. Sa paume suit votre dos tandis que sa bouche revient chercher la vôtre.", ["Lineva", "Cette position tient. Je compte la garder encore un moment.", "thoughtful"]],
      suggestive: ["Ses mains deviennent plus franches sous vos vêtements, toujours stables, jamais pressées. Lineva sourit lorsque votre corps vient chercher davantage de cette force contenue.", ["Lineva", "Je vous tiens. Inutile de faire semblant du contraire.", "smirk"]],
      explicit: sexLines(
        ["Lineva vous installe solidement contre les draps puis descend entre vos cuisses. Sa bouche et ses doigts gardent un rythme sûr jusqu’à votre orgasme, sans lâcher votre main lorsque votre corps se tend.", ["Lineva", "Tu peux respirer. Je ne te lâche pas.", "thoughtful"]],
      ...
      closing: ["Elle reste près de vous pendant que les cloches du port gardent leur cadence ordinaire.", ["Lineva", "Ne bougez pas. Ce n’est pas un ordre. C’est une demande bien formulée.", "thoughtful"]],
    ...
    },
    {
      ...
      tender: ["Vous embrassez les marques de l’armure et les endroits qu’aucun uniforme ne montre. Lineva ferme les yeux et guide votre main plus bas.", ["Lineva", "Gardez ce rythme. Il me plaît.", "thoughtful"]],
      ...
      explicit: sexLines(
        ["Vous suivez ses cicatrices puis son ventre jusqu’à l’intérieur de ses cuisses. Votre bouche et vos doigts font céder Lineva par vagues ; son orgasme la traverse sans qu’elle cherche à se redresser.", ["Lineva", "Tu restes là. Le monde peut attendre une minute.", "thoughtful"]],
      ...
      closing: ["Lorsque Lineva rouvre les yeux, aucune cloche n’a sonné. Elle vous attire à nouveau contre elle avec un sourire bref.", ["Lineva", "La prochaine fois, nous commençons avant minuit.", "thoughtful"]],
    ...
    },
    {
      ...
      tender: ["Vous finissez enlacé·es, chacun·e gardant l’autre pendant quelques respirations avant qu’un nouveau baiser relance le jeu.", ["Lineva", "Votre tour. Surprenez-moi.", "thoughtful"]],
      ...
      closing: ["Lineva reste contre vous, une jambe mêlée aux vôtres, et regarde l’aube gagner la fenêtre.", ["Lineva", "Votre tour de choisir : café maintenant ou encore dix minutes ici ?", "smirk"]],
