...
const CHARACTER_NAMES: Record<string, string> = {
  ...
  lineva: "Lineva", saidin: "Saidin", bellirith: "Bellirith", amanea: "Amanea", tia: "Tia", allenna: "Allenna",
};
...
const ROUTE_SEEDS: Record<string, RouteSeed[]> = {
  ...
  tia: [
    ...
    },
    {
      ...
      setup: ["Tia commence par organiser les coussins, le verrou et la distance de la bougie. Vous interrompez doucement cette dernière procédure en embrassant sa paume nue.", ["{player}", "Tu peux préparer une limite. Tu n’as pas besoin de préparer chaque sensation."], ["Tia", "Distinction reçue. Continuez.", "troubled"]],
  ...
  allenna: [
    {
      ...
      setup: [["Allenna", "Je connais les corps blessés, les corps épuisés et les corps qu’il faut maintenir en vie. Le vôtre n’est aucune de ces missions. Dites-moi ce qui lui plaît.", "troubled"], "Elle attend votre réponse avant de vous allonger, puis son baiser fait disparaître la dernière distance professionnelle qu’elle avait tenté de conserver."],
      deepening: ["Ses mains explorent avec méthode, mais la méthode change chaque fois que votre souffle ou vos hanches contredisent son hypothèse. Allenna sourit lorsqu’elle trouve enfin un geste qu’aucun manuel n’aurait pu lui apprendre.", ["Allenna", "Celui-ci. Votre corps vient de le classer prioritaire.", "smirk"]],
      ...
      explicit: sexLines(
        ["Allenna s’installe entre vos cuisses, maintient la pression choisie autour de votre perle de plaisir et ajoute ses doigts seulement lorsque vous la ramenez plus près. Elle garde cette cadence jusqu’à votre orgasme.", ["Allenna", "Je ne change rien. Votre corps a été parfaitement clair.", "smirk"]],
        ["Allenna referme sa main sur votre membre dressé, apprend votre rythme puis vous prend dans sa bouche avec une attention qui devient bientôt gourmande. Elle conserve le mouvement réclamé jusqu’à votre abandon.", ["Allenna", "Pas un patient. Pas un ordre. Seulement vous, ici, en train de me faire confiance.", "smirk"]],
        ["Allenna suit le point de plaisir, la profondeur et le type de contact que vous lui avez indiqués. Sa bouche et ses mains s’accordent à votre corps réel jusqu’à ce que votre orgasme rompe enfin sa concentration.", ["Allenna", "Je peux apprendre sans vous réduire à ce que je connais déjà.", "smirk"]],
      ),
    ...
    },
    {
      ...
      deepening: ["Vous embrassez ses cicatrices sans raconter leur histoire à sa place. Allenna guide votre main vers la chaleur plutôt que vers les anciennes douleurs, puis cesse enfin de préparer le geste qu’elle devra vous rendre.", ["Allenna", "Continuez. Je ne planifie pas la suite. C’est inconfortable… et très agréable.", "shy"]],
      ...
      explicit: sexLines(
        ["Votre bouche trouve la chaleur intime d’Allenna pendant que vos doigts prolongent chaque pression. Elle demande davantage sans reprendre la conduite, puis jouit en agrippant votre main libre au lieu de ses gantelets.", ["Allenna", "Je reçois. Rien ne s’effondre. Ne changez surtout pas ce rythme.", "shy"]],
        ["Vous préparez Allenna avec patience, suivez l’angle qu’elle choisit et gardez une main sur son point de feu pendant le mouvement. Elle accepte la profondeur puis la cadence qui la conduisent à l’orgasme sans transformer la scène en endurance.", ["Allenna", "Assez ferme. Toujours libre. Continuez.", "shy"]],
        ["Vous demandez quelle stimulation, quel frottement ou quelle pénétration Allenna souhaite recevoir, puis adaptez chaque position à vos corps présents. Elle guide une fois et vous confie ensuite la continuité jusqu’à son plaisir.", ["Allenna", "Vous tenez la relève. Je peux enfin cesser de surveiller.", "shy"]],
      ),
    ...
    },
    {
      ...
      deepening: ["Vous échangez conduite et soutien au rythme de vos souffles. Lorsque les vêtements gênent, Allenna les retire sans détour ; lorsque son ancienne blessure tire, vous adaptez ensemble l’angle sans traiter cette limite comme une défaite.", ["{player}", "Relève."], ["Allenna", "Reçue. À mon tour de vous porter.", "smirk"]],
