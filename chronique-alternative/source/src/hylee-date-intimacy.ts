...
const SCENES: AuthoredScene[] = [
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee écarte vos cuisses sur la couverture et laisse ses doigts découvrir votre chaleur. Elle recueille l'humidité sur votre peau, frôle le point le plus sensible et change aussitôt de pression quand vos hanches se soulèvent.", ["Hylee", "Ah. C'est là que tu oublies de me laisser gagner.", "teasing"]],
      ...
      V(
        ...
        ["Vous goûtez Hylee entre les cuisses. Sa chaleur s'offre à votre langue ; elle guide votre bouche vers l'endroit qui la fait trembler, puis s'ouvre elle-même sous vos doigts pour vous offrir un contact plus précis.", ["Hylee", "Oui. Reste là… non, attends, un peu plus haut. Voilà.", "determined"]],
      ...
      V(
        ...
        ["Hylee se place tête-bêche sur la couverture. Sa bouche revient là où vous êtes la plus sensible tandis que vos doigts et votre langue retrouvent le même point chez elle ; elle perd le rythme, rit contre votre peau et revient avec une application redoublée."],
      ...
      V(
        ...
        ["Vos chaleurs se pressent l'une contre l'autre entre vos cuisses croisées. Hylee change l'angle, reprend votre bouche et accélère lorsqu'elle vous sent trembler."],
        ["Hylee maintient vos bassins serrés et trouve contre vous le frottement le plus vif. Sa main ajoute une pression exacte entre vos corps ; le plaisir vous emporte la première, puis vos mouvements désordonnés et vos doigts la font jouir contre votre cuisse.", ["Hylee", "J'avais dit que ça comptait double… je ne sais toujours pas pour quoi.", "teasing"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee referme la main sur votre désir tendu à travers le dernier tissu, observe votre souffle changer et recommence avec une lente fierté."],
        ["Elle vous libère du dernier tissu et referme ses doigts autour de vous. Son pouce glisse sur l'extrémité humide ; Hylee essaie deux pressions, garde celle qui vous fait fermer les yeux et sourit comme après une sculpture enfin stable.", ["Hylee", "Celle-là. Je garde ce mouvement.", "teasing"]],
      ...
      V(
        ...
        ["Vos doigts trouvent son intimité humide, puis le point précis qui lui arrache un souffle. Hylee vous montre le cercle qui lui plaît, vous laisse l'apprendre et vous arrête brusquement pour attirer votre bouche entre ses cuisses.", ["Hylee", "Je veux savoir ce que ça fait avec ta langue. Maintenant, si possible.", "determined"]],
      ...
      V(
        ...
        ["Elle alterne sa bouche et sa main sur vous, puis remonte vous embrasser pour réclamer le même soin entre ses jambes."],
        ["Hylee vous prend dans sa bouche, joue de sa langue sous l'extrémité sensible puis vous libère au moment où vos hanches cherchent davantage. Elle se place au-dessus de vous et guide votre désir contre sa chaleur humide sans cesser de vous regarder."],
      ...
      V(
        ...
        ["Elle accélère au-dessus de vous, une main sur votre poitrine et l'autre entre ses cuisses. Sa respiration se brise lorsque vos doigts retrouvent l'endroit qui la fait céder."],
        ["Hylee vous chevauche avec une cadence de plus en plus assurée. Vous entretenez le plaisir sous ses doigts pendant qu'elle resserre ses cuisses autour de vos hanches ; la jouissance l'immobilise un instant sur vous, puis elle reprend assez longtemps pour vous conduire à la vôtre.", ["Hylee", "Attends… voilà. Maintenant tu peux perdre aussi.", "determined"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee glisse une main entre vos jambes et découvre votre intimité humide. Ses doigts suivent lentement vos lèvres, remontent vers leur point le plus sensible puis s'immobilisent lorsque votre souffle change.", ["Hylee", "C'est bien ici ?"], ["{player}", "Oui. Continue."], "Elle reprend, plus sûre."],
      ...
      V(
        ...
        ["Vous embrassez l'intérieur de ses cuisses avant de goûter sa chaleur. Hylee se crispe, reprend votre main et la place sur son ventre ; votre langue trouve l'endroit qui la fait trembler quand elle cesse de retenir son bassin.", ["Hylee", "Ne t'arrête pas parce que je tremble. Je te le dirai si je veux arrêter.", "determined"]],
      ...
      V(
        ...
        ["Allongées face à face, vous glissez chacune une main entre les cuisses de l'autre. Hylee apprend la caresse qui vous trouble le plus tandis que vos doigts entrent doucement en elle ; elle change l'angle de sa hanche pour vous offrir plus de place."],
      ...
      V(
        ...
        ["Hylee serre vos doigts en elle tandis que son pouce insiste sur votre point sensible. Le plaisir vous cambre contre sa paume ; elle ramène votre main entre ses cuisses et vient jouir sous vos doigts, le visage enfoui contre votre cou."],
  ...
  },
  {
    ...
    chapters: [
      ...
      A("Nue dans la lumière basse, elle rougit jusqu'aux oreilles. Sa première réaction est de rapprocher ses jambes ; la seconde, choisie, est d'avancer vers vous.", "Hylee retire votre dernier vêtement et regarde votre désir se dresser sans reculer. Elle touche d'abord votre hanche, puis descend sa main lorsqu'elle se sent prête.", ["Hylee", "Je vais peut-être demander beaucoup de choses. Ce n'est pas parce que je veux partir.", "determined"]),
      V(
        ...
        ["Elle vous caresse dans sa paume, sans brusquer le premier contact. La réponse de votre corps lui arrache un sourire qu'elle essaie inutilement de cacher."],
        ["Hylee vous entoure de ses doigts, découvre votre longueur puis l'extrémité d'un pouce prudent. Votre souffle l'encourage ; elle ajuste sa prise et vous regarde avant chaque changement.", ["Hylee", "Comme ça ? Je veux sentir quand ça devient vraiment bon."], "Vous lui montrez. Elle retient le rythme."],
      ...
      V(
        ...
        ["Vos doigts séparent ses lèvres humides et dessinent un cercle là où elle est la plus sensible. Hylee guide votre main, retire la sienne lorsqu'elle vous sent comprendre, puis vous demande de glisser un doigt en elle sans interrompre la caresse."],
      ...
      V(
        ...
        ["Hylee caresse votre désir puis vous attire entre ses cuisses. Elle teste la proximité sans se presser d'aller plus loin, attentive à votre respiration comme à la sienne."],
        ["Hylee vous guide contre sa chaleur, laisse votre extrémité glisser sur l'endroit le plus sensible et s'arrête pour savourer le frisson. Lorsqu'elle vous accueille enfin, elle garde une main sur votre hanche et règle elle-même la profondeur.", ["Hylee", "Reste près. Je veux te voir.", "soft"]],
      ...
      V(
        ...
        ["Hylee cherche entre vos bassins la pression qui lui plaît, accélère et jouit contre vous. Elle continue à bouger, plus doucement, jusqu'à sentir votre plaisir vous traverser à votre tour."],
        ["Vous glissez en elle au rythme qu'elle maintient. Hylee se caresse d'une main, jouit en serrant vos hanches contre les siennes, puis reprend des mouvements courts jusqu'à votre propre abandon, le front appuyé au vôtre."],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee écarte vos jambes et laisse deux doigts glisser dans votre humidité. Elle cerne le point qui vous fait frissonner, accélère dès que vos hanches répondent puis plonge un doigt en vous sans interrompre le mouvement de son pouce.", ["Hylee", "Dis mon nom si tu veux plus. Je veux l'entendre.", "determined"]],
      ...
      V(
        ...
        ["Votre langue se glisse entre ses lèvres et revient là où son plaisir se concentre. Hylee relève le bassin contre votre bouche, guide vos cheveux d'une main et utilise l'autre sur son propre sein.", ["Hylee", "Plus fort. Oui, comme ça. Je te dirai quand changer.", "determined"]],
      ...
      V(
        ...
        ["Hylee place sa cuisse contre votre chaleur et vient frotter la sienne sur la vôtre. Vous trouvez tour à tour la pression juste ; elle vous tient par les hanches et change la cadence dès qu'elle entend votre souffle céder."],
      ...
      V(
        ...
        ["Son bassin frotte le vôtre pendant que vos doigts entretiennent chacune le plaisir de l'autre. Hylee jouit avec un cri bref, reprend aussitôt la caresse qui vous trouble et vous suit jusqu'à votre propre secousse."],
        ["Hylee maintient sa chaleur contre la vôtre, une main là où vous êtes la plus sensible et l'autre agrippée à votre hanche. Elle vous fait jouir sous elle, observe votre visage avec une fierté ouverte, puis réclame vos doigts en elle et atteint à son tour le sommet sans ralentir ses propres caresses."],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Elle caresse votre désir d'une main lente tout en mordillant votre ventre. La manière dont vos hanches cherchent sa paume lui plaît ouvertement."],
        ["Hylee vous saisit à la base, remonte jusqu'à l'extrémité humide et y fait tourner son pouce. Elle garde votre regard, accélère puis ralentit juste pour entendre votre protestation.", ["Hylee", "Voilà. Cette tête-là. Je voulais être sûre que je pouvais la refaire.", "teasing"]],
      ...
      V(
        ...
        ["Votre langue se glisse entre ses lèvres avant de s'attarder sur leur point le plus sensible. Hylee appuie une main sur votre nuque, règle la pression de l'autre sur son sein et vous donne des indications courtes jusqu'à ce que ses cuisses tremblent."],
      ...
      V(
        ...
        ["Hylee frotte sa chaleur contre votre désir, vous embrasse puis change de position pour prendre appui sur ses pieds et décider de chaque mouvement."],
        ["Elle fait glisser votre désir entre ses lèvres humides, insiste là où le frisson se concentre puis vous guide en elle. Hylee descend lentement sur vous, s'arrête une fois pour ajuster l'angle et reprend jusqu'à vous accueillir entièrement."],
      ...
      V(
        ...
        ["Elle se caresse pendant qu'elle bouge sur vous. Son orgasme la fait se contracter et s'appuyer contre votre torse ; elle repart plus lentement jusqu'à sentir votre propre abandon."],
        ["Vous coulissez en elle pendant qu'Hylee se caresse d'une main. Elle jouit au-dessus de vous, maintient ses hanches serrées puis reprend des mouvements courts et profonds jusqu'à votre propre déferlement, attentive à chaque secousse qu'elle provoque.", ["Hylee", "Oui. Je voulais te sentir arriver comme ça.", "determined"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee vous découvre d'une main et fait passer un doigt humide autour de votre point le plus sensible. Elle essaie un cercle, une pression plus directe puis un mouvement lent de haut en bas, attentive à celui qui fait glisser vos hanches vers elle.", ["Hylee", "Celui-là t'a fait oublier tes pieds. Je le garde.", "teasing"]],
      ...
      V(
        ...
        ["Vous glissez deux doigts entre ses lèvres humides, puis votre langue sur l'endroit qui la fait frissonner. Hylee écarte davantage les jambes et invente de compter vos passages ; elle perd le compte au quatrième et vous demande de recommencer depuis le début.", ["Hylee", "C'est une vérification très sérieuse.", "teasing"]],
      ...
      V(
        ...
        ["Hylee referme sa bouche sur votre point sensible pendant que votre langue retrouve le sien. Quand elle perd le rythme, elle utilise ses doigts sur vous ; vous répondez de la même façon et vos corps alternent bouche, paume et bassin sans désigner de gagnante."],
      ...
      V(
        ...
        ["Hylee se frotte contre votre cuisse tandis que ses doigts accélèrent sur votre point sensible. Elle jouit en vous serrant, garde sa main en mouvement et vous accompagne jusqu'à votre propre abandon."],
        ["Vos chaleurs se rencontrent entre vos jambes croisées. Hylee trouve l'angle qui concentre le plaisir, maintient la cadence malgré ses soupirs et vous fait jouir contre elle ; vos doigts entrent ensuite en elle pendant qu'elle se frotte à votre paume jusqu'à son propre sommet.", ["Hylee", "Égalité. Mais une vraie, cette fois.", "teasing"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Sa main enveloppe votre désir avec une lenteur calculée. Elle vous embrasse juste au moment où sa paume remonte, puis recommence pour voir si l'effet se répète."],
        ["Hylee fait glisser sa main le long de vous, tourne son pouce autour de l'extrémité et recueille l'humidité qui s'y forme. Elle la prend ensuite entre ses lèvres, vous regarde perdre votre souffle et sourit avant de descendre davantage.", ["Hylee", "Deux points. Au moins.", "teasing"]],
      ...
      V(
        ...
        ["Votre main se glisse entre ses cuisses. Elle presse sa chaleur contre vos doigts et se cambre lorsqu'ils remontent vers son point sensible."],
        ["Votre langue rejoint son intimité offerte. Hylee guide votre bouche là où le plaisir affleure, vous arrête pour changer l'angle et vous ramène aussitôt entre ses jambes dès que le nouveau contact la fait gémir.", ["Hylee", "Celui-là vaut plus que trois. Je réviserai les règles après.", "determined"]],
      ...
      V(
        ...
        ["Elle frotte sa chaleur contre votre désir puis alterne sa main sur vous et la vôtre entre ses cuisses, changeant la règle chaque fois que l'un de vous approche trop vite du plaisir."],
        ["Hylee vous reprend dans sa bouche jusqu'à vous sentir dur contre sa langue, puis vient à califourchon. Elle vous guide le long de ses lèvres humides, insiste sur le point qui la fait frissonner et vous accueille lorsqu'elle a choisi l'angle qui lui plaît."],
      ...
      V(
        ...
        ["Elle cherche son plaisir contre votre bassin pendant qu'elle monte et descend sur vous. Sa jouissance brise le décompte ; elle poursuit jusqu'à sentir la vôtre répondre sous elle."],
        ["Hylee vous chevauche, se caresse entre les cuisses et accélère chaque fois que votre souffle se défait. Elle jouit en se contractant autour de vous, puis reprend des mouvements courts jusqu'à votre propre abandon et s'immobilise seulement quand vos mains cessent de trembler."],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee écarte doucement vos lèvres et trouve votre humidité. Elle effleure d'un doigt l'endroit où naît un frisson, observe votre respiration puis recommence avec deux doigts plus fermes.", ["Hylee", "Je sens quand tu te rapproches. Dis-moi seulement si je dois changer.", "soft"]],
      ...
      V(
        ...
        ["Vous goûtez sa chaleur et remontez vers l'endroit le plus sensible. Hylee ouvre davantage les jambes, vous guide d'une main dans vos cheveux et demande un doigt en elle lorsque le plaisir devient plus pressant.", ["Hylee", "Oui. Là, je n'ai plus froid du tout.", "soft"]],
      ...
      V(
        ...
        ["Face à face, vos cuisses se mêlent et vos mains alternent entre vos seins et votre intimité. Hylee garde votre regard chaque fois qu'un mouvement la surprend."],
        ["Hylee glisse deux doigts en vous pendant que votre main caresse sa chaleur. Vous trouvez le point qui la fait frémir ; elle ajuste sa hanche, vous offre un rythme et recherche le vôtre avec la même attention, vos bouches à portée d'un souffle."],
      ...
      V(
        ...
        ["Vos doigts accélèrent sur les points qu'ils ont appris. Hylee jouit contre votre main, reprend son souffle sans retirer la sienne et vous mène au plaisir en répétant le mouvement qui vous avait trahie."],
        ["Votre main entre en Hylee pendant que son pouce presse l'endroit qui vous fait perdre le rythme. Elle jouit autour de vos doigts, le visage contre le vôtre ; sa main reprend aussitôt une cadence plus ferme entre vos cuisses jusqu'à ce que le plaisir vous serre contre elle."],
  ...
  },
  {
    ...
    chapters: [
      ...
      A("Hylee se tient nue entre vos jambes. Elle rougit lorsque vous regardez son corps entier, puis pose vos paumes sur ses hanches au lieu de se couvrir.", "Elle ouvre votre pantalon et découvre votre désir tendu. Son souffle hésite ; ses doigts, eux, viennent en suivre la forme avec une douceur décidée.", ["Hylee", "Tu me dis si je fais quelque chose que tu n'aimes pas. Pour le reste, laisse-moi essayer.", "determined"]),
      V(
        ...
        ["Hylee vous prend dans sa paume et vous caresse lentement. Elle observe la tension de votre ventre, puis revient vous embrasser sans retirer sa main."],
        ["Ses doigts vous entourent et remontent jusqu'à l'extrémité sensible. Hylee y étale l'humidité du pouce, change de pression quand vos hanches répondent et se penche pour la goûter avant de reprendre le mouvement de sa main."],
      ...
      V(
        ...
        ["Votre main descend entre ses cuisses. Elle ouvre les jambes et presse sa chaleur contre votre paume, montrant elle-même le mouvement dont elle a envie."],
        ["Vos doigts longent ses lèvres humides et trouvent leur point le plus sensible. Hylee guide deux cercles, vous laisse continuer puis vous demande un doigt en elle ; elle accompagne l'entrée d'un mouvement de bassin qui ne doit rien à l'attente passive."],
      ...
      V(
        ...
        ["Elle frotte sa chaleur contre votre désir, puis guide vos hanches plus près. La proximité devient plus ferme sans que son regard quitte le vôtre."],
        ["Hylee vous fait glisser contre ses lèvres, s'attarde là où la pression la fait frissonner puis vous guide en elle. Elle vous accueille lentement sur le côté, ajuste elle-même sa jambe et reprend le mouvement lorsque la profondeur lui convient.", ["Hylee", "Comme ça. Je peux bouger aussi.", "soft"]],
      ...
      V(
        ...
        ["Votre main entretient son plaisir pendant que vos corps restent unis. Elle jouit contre vous, puis ses hanches continuent avec une douceur ferme jusqu'à sentir votre propre vague."],
        ["Vous coulissez en elle pendant que vos doigts pressent le point qui la fait céder. Hylee jouit en serrant sa jambe autour de vous ; elle reprend, plus lente mais volontaire, et vous conduit au plaisir sans rompre le contact de vos fronts."],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee vous ouvre contre sa cuisse, recueille votre humidité puis presse de deux doigts le point où votre plaisir affleure. Elle vous maintient par la hanche pendant que votre bassin suit la cadence qu'elle impose.", ["Hylee", "Oui. Laisse tes jambes trembler. Je te tiens.", "determined"]],
      ...
      V(
        ...
        ["Votre langue parcourt son intimité offerte et revient à l'endroit qui la fait trembler avec un rythme soutenu. Hylee relève les hanches, glisse deux doigts en elle devant vous puis vous confie le mouvement pendant qu'elle tire votre bouche plus près."],
      ...
      V(
        ...
        ["Hylee presse sa chaleur contre votre cuisse pendant que la sienne cherche votre point sensible. Vos doigts se glissent entre vos corps, entrent tour à tour en vous et en elle ; elle règle la cadence avec ses hanches et refuse de choisir laquelle cédera d'abord."],
      ...
      V(
        ...
        ["Vos points sensibles se pressent l'un contre l'autre. Hylee maintient l'angle jusqu'à vous sentir jouir, puis guide votre main sur elle et atteint son propre plaisir avec un cri bref."],
        ["Hylee frotte son intimité humide contre la vôtre, vos plaisirs saisis dans une pression régulière. Votre jouissance la fait accélérer ; vous glissez deux doigts en elle et insistez du pouce sur le point qui la fait céder jusqu'à ce qu'elle jouisse au-dessus de vous, incapable de soutenir son sourire.", ["Hylee", "Je t'avais dit que je te tenais.", "determined"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      A("Elle tire votre chemise hors de votre pantalon et la fait passer par-dessus votre tête. Vous ouvrez sa robe ; Hylee finit elle-même les attaches, puis pose votre main sur son sein tandis que l'autre s'occupe de votre ceinture.", "Ses vêtements tombent près des bottes. Elle vous déshabille entièrement et vous guide jusqu'aux manteaux sans lâcher votre désir déjà dur."),
      A("Nue face à vous, Hylee ne cherche pas à réduire son corps au regard que vous portez. Elle vous laisse voir ses seins, ses hanches et sa peau marquée de clair, puis s'approche assez pour sentir votre désir dressé contre son ventre.", ["Hylee", "Je veux sentir ce que je te fais. Et je veux que tu me fasses répondre aussi.", "determined"]),
      V(
        ...
        ["Elle referme les doigts sur votre désir, le caresse contre sa paume et apprécie ouvertement la façon dont votre ventre se tend."],
        ["Hylee vous serre entre ses doigts, remonte jusqu'à l'extrémité et fait tourner sa langue autour avant de vous prendre dans sa bouche. Elle alterne profondeur et pression de sa main, s'arrête juste avant que vous perdiez le contrôle et remonte avec un sourire sans excuse.", ["Hylee", "Pas encore. Je veux être avec toi quand ça arrive.", "determined"]],
      ...
      V(
        ...
        ["Votre main caresse son intimité pendant que votre bouche travaille ses seins. Elle vous demande davantage et accompagne vos doigts d'un bassin impatient."],
        ["Vous glissez deux doigts en elle et pressez du pouce l'endroit où son plaisir se rassemble. Hylee prend votre rythme, le corrige d'un mouvement plus ferme puis vous attire entre ses jambes pour que votre langue remplace votre main.", ["Hylee", "Je te dirai quand j'en aurai assez. Ce n'est pas maintenant.", "determined"]],
      ...
      V(
        ...
        ["Elle frotte sa chaleur contre votre désir, change l'angle puis soulève son bassin pour vous guider plus près. Chaque décision vient d'un geste net."],
        ["Hylee vous fait glisser entre ses lèvres, s'attarde sur le point qui la trouble puis vous guide en elle. Elle descend sur vous avec une lenteur maîtrisée, ajuste la profondeur et commence à bouger sans quitter votre regard."],
      ...
      A("Elle vous chevauche d'abord en mouvements longs, puis se penche pour vous embrasser et adopte une cadence plus courte qui la fait gémir contre votre bouche. À sa demande, votre main rejoint l'endroit où son plaisir se concentre.", "Une pellicule froide apparaît une seule fois sur la pierre humide, traversée par le reflet du lac. Hylee n'en fait aucun commentaire."),
      V(
        ...
        ["Elle se caresse pendant que vous restez en elle. Sa jouissance serre vos hanches entre ses cuisses ; elle reprend, plus ferme, et vous mène jusqu'à la vôtre."],
        ["Vous coulissez profondément en Hylee tandis qu'elle presse de deux doigts le point sensible entre ses cuisses. Elle jouit en se contractant autour de vous, ralentit sans s'arrêter puis reprend jusqu'à votre propre déferlement, observant votre visage avec le plaisir franc d'en être la cause.", ["Hylee", "Oui. C'est ça que je voulais voir.", "determined"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee vous ouvre du bout des doigts, y trouve votre humidité et la porte à sa langue avec un sourire. Elle revient au point qui vous fait frissonner, teste une pression circulaire puis se penche pour remplacer sa main par sa bouche.", ["Hylee", "Oui, c'est meilleur ici. Je ne dirai rien à la recette.", "teasing"]],
      ...
      V(
        ...
        ["Votre langue goûte son humidité et retrouve l'endroit où elle frémit le plus fort. Hylee relève le bassin, guide votre bouche d'une main et se met à rire lorsqu'elle admet qu'il n'y avait évidemment aucun coulis là.", ["Hylee", "La recherche reste utile. Continue.", "determined"]],
      ...
      V(
        ...
        ["Sa langue travaille votre point sensible pendant que vous l'ouvrez de deux doigts. Hylee alterne bouche et main sur vous, puis presse son bassin contre vos lèvres ; chacune interrompt l'autre par une nouvelle idée avant de retrouver un rythme commun."],
      ...
      V(
        ...
        ["Vos doigts accélèrent sur les endroits qu'ils ont appris. Hylee jouit contre votre bouche, remonte aussitôt et vous mène au plaisir avec la main encore humide entre vos cuisses."],
        ["Vous gardez deux doigts en Hylee pendant que sa langue insiste sur votre point le plus sensible. Elle jouit autour de votre main, remonte sur vous et reprend sa caresse entre vos cuisses jusqu'à ce que le plaisir vous emporte, sa bouche ouverte contre la vôtre.", ["Hylee", "Je crois que le dessert est officiellement terminé.", "teasing"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      A("Hylee arrive nue au bord du lit, les taches claires de sa peau éclairées par le photophore. Votre regard la fait rougir mais elle avance, prend vos mains et les place sur ses hanches.", "Elle retire votre dernier vêtement et découvre votre désir dressé. Son sourire change, plus lent, lorsqu'elle constate l'effet de son corps.", ["Hylee", "Je peux faire mieux que la cuillère. C'était déjà mon idée.", "determined"]),
      V(
        ...
        ["Elle caresse votre désir dans sa paume et suit la tension de vos hanches. Une goutte de miel sur son pouce disparaît contre l'extrémité avant qu'elle prétende que c'était accidentel."],
        ["Hylee vous entoure d'une main, étale le miel sur votre pointe sensible puis le recueille lentement avec la langue. Elle vous prend dans sa bouche, combine ses lèvres et sa paume et relève les yeux pour vérifier chaque effet.", ["Hylee", "Beaucoup mieux. La cuillère est battue.", "teasing"]],
      ...
      V(
        ...
        ["Votre main trouve sa chaleur. Elle frotte contre vos doigts, puis les replace plus haut avec un geste direct pour obtenir la pression qu'elle veut."],
        ["Vous l'ouvrez sous vos doigts et caressez le point humide qui la fait frissonner. Hylee place deux doigts en elle devant vous, vous les confie puis attire votre bouche entre ses cuisses, ravie de transformer la découverte en défi réciproque."],
      ...
      V(
        ...
        ["Sa chaleur frotte contre votre désir pendant qu'elle vous embrasse. Elle teste l'appui du dossier, approuve et vous fait glisser plus bas pour pouvoir mener le mouvement."],
        ["Hylee vous fait rouler entre ses doigts, presse votre extrémité contre l'endroit qui la trouble puis vous guide en elle. Elle descend sur vous au milieu du canapé, trouve un rythme avec ses pieds au sol et rit quand le meuble grince avant elle."],
      ...
      V(
        ...
        ["Hylee se caresse pendant qu'elle bouge sur vous. La jouissance lui fait perdre l'appui du dossier ; vous la retenez, et elle reprend assez pour vous conduire à votre tour."],
        ["Vous coulissez en Hylee tandis que ses doigts entretiennent son plaisir. Elle jouit au-dessus de vous, se cramponne à vos épaules puis poursuit en mouvements courts jusqu'à votre propre abandon, attentive à la façon dont votre corps se tend sous elle.", ["Hylee", "Le canapé tient. Nous aussi, presque.", "teasing"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Hylee vous ouvre avec des doigts prudents, trouve le point où votre désir affleure et le caresse lentement. Elle glisse un doigt en vous lorsque vous la rapprochez et observe votre visage pour ajuster la profondeur.", ["Hylee", "Je te sens venir vers ma main. Continue de me montrer.", "soft"]],
      ...
      V(
        ...
        ["Vous glissez les doigts dans son humidité et cernez l'endroit qui la rend plus fébrile. Hylee vous demande une pression plus ferme, puis un doigt en elle ; elle accompagne chaque entrée du bassin et garde votre autre main serrée contre son sein."],
      ...
      V(
        ...
        ["Vos doigts circulent entre vos seins, vos ventres puis votre intimité. Hylee trouve un rythme sur vous et guide le vôtre sur elle sans précipiter la réponse."],
        ["Hylee glisse deux doigts en vous pendant que votre main entre doucement en elle. Vos pouces entretiennent vos plaisirs ; elle bouge contre votre paume, vous embrasse et reprend elle-même le mouvement chaque fois qu'un frisson l'interrompt."],
      ...
      V(
        ...
        ["Vos doigts accélèrent sur les endroits qui vous font céder. Hylee jouit contre votre paume, reprend le mouvement sur vous et vous accompagne jusqu'au plaisir en gardant son front au vôtre."],
        ["Les doigts d'Hylee se courbent en vous pendant que son pouce travaille votre point sensible. Votre jouissance serre sa main ; vous maintenez la vôtre en elle et pressez le sien jusqu'à ce qu'elle jouisse contre vous, bouche ouverte sur votre nom."],
  ...
  },
  {
    ...
    chapters: [
      ...
      A("Nue devant vous, Hylee inspire sous votre regard et pose elle-même vos mains sur ses hanches. Elle regarde votre corps à son tour, retire le dernier tissu et découvre votre désir dressé avec un mélange de gêne et d'envie très lisible.", ["Hylee", "Je peux rougir et avoir envie de te toucher. Les deux sont vrais."], "Sa main descend pour le prouver."),
      V(
        ...
        ["Sa main se referme sur votre désir. Elle vous caresse lentement, sans détourner les yeux lorsque votre souffle change, puis vous demande d'un sourire si elle peut continuer."],
        ["Hylee vous entoure de ses doigts, remonte jusqu'à l'extrémité et y fait glisser son pouce humide. Elle apprend la pression par vos hanches, se penche pour vous prendre dans sa bouche et combine prudemment ses lèvres et sa main.", ["Hylee", "Montre-moi encore. J'ai compris, mais j'aime bien vérifier.", "soft"]],
      ...
      V(
        ...
        ["Vos doigts trouvent sa chaleur. Elle ouvre les jambes, déplace votre pouce vers son point sensible et vous montre la cadence qu'elle veut par un mouvement continu de bassin."],
        ["Vous caressez l'endroit qui la fait frémir, glissez un doigt en elle puis un second quand elle vous le demande. Hylee serre vos doigts, vous attire entre ses cuisses et guide votre langue jusqu'à l'endroit où ses mots deviennent des souffles."],
      ...
      V(
        ...
        ["Hylee frotte sa chaleur le long de votre désir, s'habitue à la proximité et vous embrasse chaque fois que sa gêne tente de lui voler le regard."],
        ["Elle vous guide contre le point qui la fait frémir puis jusqu'à son intimité humide. Hylee vous accueille lentement sur le côté, ajuste la profondeur avec sa jambe et commence elle-même les mouvements, front contre front.", ["Hylee", "Ne fais pas tout. J'ai envie de venir vers toi aussi.", "determined"]],
      ...
      V(
        ...
        ["Votre main entretient son plaisir pendant que vos bassins bougent ensemble. Hylee jouit contre vous, reprend des mouvements doux et vous conduit au même abandon sans quitter votre regard."],
        ["Vous glissez en Hylee tandis que vos doigts pressent l'endroit qui la fait céder. Elle jouit en serrant sa jambe autour de vous, puis continue volontairement jusqu'à votre propre déferlement, attentive à chaque contraction de votre ventre et à la chaleur qui vous quitte."],
  ...
  },
  {
    ...
    chapters: [
      ...
      V(
        ...
        ["Elle vous ouvre et caresse votre point le plus sensible avec deux doigts déjà humides. Hylee glisse un doigt en vous, puis un second, et courbe sa main jusqu'à trouver le mouvement qui vous fait saisir les draps.", ["Hylee", "Oui. Je voulais voir ce que tu ferais avec tes mains quand les miennes seraient là.", "teasing"]],
      ...
      V(
        ...
        ["Vous embrassez sa poitrine puis son ventre. Elle presse votre main contre son intimité et vous demande une caresse ferme, sans euphémisme dans son geste."],
        ["Votre langue insiste là où elle est la plus sensible pendant que deux doigts entrent en elle. Hylee roule les hanches contre votre bouche, vous ordonne de ne pas ralentir et serre ses seins de ses propres mains lorsque le plaisir devient plus vif."],
      ...
      V(
        ...
        ["Debout entre vos jambes, elle presse sa cuisse contre votre chaleur puis vous attire à son tour au bord de la table. Vos mains circulent sans attribuer durablement la conduite."],
        ["Hylee vient s'asseoir sur votre cuisse, offerte contre votre peau, tandis que la sienne se glisse entre vos jambes. Vos plaisirs trouvent tour à tour la pression juste ; vos doigts s'ajoutent entre vous lorsque le frottement ne suffit plus.", ["Hylee", "Je veux que tu te souviennes de cette table autrement.", "determined"]],
      ...
      V(
        ...
        ["Hylee fait jouir votre corps sous sa main, puis presse la vôtre contre son point sensible et se laisse conduire à son tour dans un mouvement toujours franc."],
        ["Ses doigts se courbent en vous pendant que son pouce travaille le point qui vous fait céder. Vous jouissez contre la table ; Hylee place ensuite votre main entre ses cuisses, se frotte contre votre paume et atteint à son tour le sommet sans détourner les yeux.", ["Hylee", "Voilà. Cette maison sait maintenant que je suis venue.", "determined"]],
  ...
  },
  {
    ...
    chapters: [
      ...
      A("Nue dans la lumière du photophore, Hylee se place entre vous et la table, offerte à votre regard sans chercher à devenir immobile. Elle prend vos mains et les fait parcourir ses seins, ses flancs et ses fesses.", "Puis elle vous libère du dernier tissu, observe votre désir dressé contre son ventre et resserre les doigts autour avec un sourire assumé.", ["Hylee", "Je voulais te trouver comme ça chez toi. Maintenant, je veux savoir tout ce que je peux en faire.", "determined"]),
      V(
        ...
        ["Sa main travaille votre désir pendant que sa bouche suit votre ventre. Hylee varie la pression, observe vos doigts se crisper sur le bord et garde le mouvement qui vous trouble le plus."],
        ["Hylee vous enveloppe d'une main ferme, lèche l'extrémité puis vous prend dans sa bouche. Elle combine sa langue sous la pointe sensible et la paume sur toute la longueur, vous mène près du plaisir et s'arrête volontairement.", ["Hylee", "Pas sur la table. J'ai une autre idée pour la fin.", "teasing"]],
      ...
      V(
        ...
        ["Vos doigts caressent sa chaleur pendant que votre bouche revient sur ses seins. Elle presse son bassin contre votre paume et réclame un mouvement plus ferme."],
        ["Vous l'ouvrez sous vos doigts, tournez autour du point qui la fait frémir puis glissez deux doigts en elle. Hylee guide la courbe de votre main, vous attire entre ses cuisses et se frotte à votre langue jusqu'à perdre la netteté de ses ordres."],
      ...
      V(
        ...
        ["Elle se frotte contre votre désir, étale sa chaleur sur vous et change la pression selon son propre plaisir autant que le vôtre."],
        ["Hylee vous fait glisser entre ses lèvres, presse votre extrémité contre l'endroit qui la fait frissonner puis vous guide en elle. Elle descend entièrement, ajuste l'angle et commence à vous chevaucher avec une cadence qu'elle n'a aucune envie de vous céder."],
      ...
      V(
        ...
        ["Elle presse son point sensible sous vos doigts tandis qu'elle bouge sur vous. La jouissance la fait se contracter autour de vous ; Hylee reprend aussitôt une cadence plus courte jusqu'à sentir votre propre abandon."],
        ["Vous coulissez en Hylee pendant que vos doigts entretiennent son plaisir. Elle jouit au-dessus de vous, vous regarde céder sous les contractions qui la traversent puis continue à vous chevaucher jusqu'à votre propre déferlement, les mains fermes sur votre poitrine.", ["Hylee", "Oui. C'était exactement mon autre idée.", "determined"]],
