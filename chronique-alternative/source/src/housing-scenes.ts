...
export const HOME_DATE_PROFILES: Record<string, HomeDateProfile> = {
  ...
  lineva: {
    character: "lineva", title: "Une relève à domicile", description: "Donner à Lineva une mission inhabituelle : concevoir une soirée qui ne protège, ne ravitaille et ne commande personne.", gift: "homegift-lineva",
    ...
    cityComments: cities("Lineva", "La capitale est loin de la mer mais proche de toutes les tempêtes politiques. Ton toit semble correctement amarré.", "Forthaven, donc. Je pourrais te parler du vent, des remparts et du prix du sel. La vérité, c’est que savoir ta porte ici me fait quelque chose de beaucoup moins tactique.", "Ici, les défenses sont magiques et les rapports météorologiques inutiles. Je comprends pourquoi les mages dorment mieux.", "Une maison au cœur d’Akuhn’Nabad exige du courage et une excellente serrure. Tu sembles posséder les deux."),
    tierComments: tier("Lineva", ["Fonctionnel, solide et impossible à remplir de réunions. Excellent.", "Tu as investi dans le confort sans sacrifier les issues. Bonne décision.", "Une vraie demeure. Il faudra simplement définir qui surveille quoi — non. Pardon. Aucun tableau de garde.", "Cette maison pourrait loger un état-major. Interdiction formelle d’en profiter.", "Je pourrais perdre une patrouille entière dans cette chambre. La vue justifie presque l’absurdité." ]),
    ownItemComment: "La clé… Je te l’avais confiée pour me rappeler de ne pas rouvrir le coffre. L’exposer me rappelle surtout que j’y suis arrivée.", otherItemComment: "Tu gardes les preuves de ce que les gens te confient. C’est une forme de responsabilité que je comprends.",
    tones: {
      amical: { label: "Permission de souffler", detail: "Partager un loisir sans transformer son repos en romance.", effects: { affection: 6, trust: 10 }, lines: [P("Je veux seulement te donner une soirée où tu n’es responsable de personne."), C("Lineva", "Objectif difficile. Conditions acceptées.", "thoughtful")] },
      amoureux: { label: "Une place au port", detail: "Construire une proximité tendre et lui montrer qu’un foyer peut attendre son retour.", effects: { affection: 9, trust: 8, desire: 4 }, lines: [P("J’aimerais que tu voies cette porte comme un endroit où revenir, pas un poste à défendre."), C("Lineva", "Je vais avoir besoin de plusieurs visites pour intégrer cette distinction.", "thoughtful")] },
      desir: { label: "Après la dernière ronde", detail: "Laisser la discipline céder à une tension retenue depuis trop longtemps.", effects: { affection: 6, trust: 6, desire: 10 }, lines: [P("La maison est sûre. Tu peux cesser de surveiller les fenêtres et t’occuper de moi."), C("Lineva", "Ordre recevable. Exécution immédiate après la maquette.", "smirk")] },
    },
    rounds: [
    ...
    results: { close: [C("Lineva", "Il flotte très mal sur une étagère. Je découvre que c’est exactement sa mission.", "thoughtful")], warm: [C("Lineva", "Garde-le ici. J’aurai une raison concrète de vérifier son état.", "smirk")], perfect: [N("La maquette baptisée Le Retour rejoint vos objets."), C("Lineva", "Ce navire n’a aucune urgence. Nous non plus, pour le reste de la soirée.", "thoughtful")] },
  },
  saidin: {
  ...
  allenna: {
    character: "allenna", title: "La garde déposée près de la porte", description: "Inviter Allenna à préparer une trousse de secours qui n’est destinée à aucune bataille et lui apprendre qu’une maison peut rester sûre sans poste de garde.", gift: "homegift-allenna",
    activityTitle: "La trousse des jours ordinaires", activityInstruction: "Composez une trousse pour les brûlures de cuisine, les ampoules et les lendemains trop courts — rien qui exige une armée.",
    arrival: [N("Allenna entre après avoir vérifié deux fois le couloir. Elle apporte une petite boîte de bois sombre dont les compartiments sont impeccablement étiquetés."), C("Allenna", "Trousse domestique. Pas de poison, pas de garrot de campagne et seulement trois choses capables de recoudre quelqu’un. J’ai fait un effort.", "smirk")],
    ...
    tones: {
      amical: { label: "Relève sans rapport", detail: "Partager une soirée où Allenna n’a ni troupe à inspecter ni dette à acquitter.", effects: { affection: 6, trust: 9 }, lines: [P("Ce soir, personne ne dépend de ta vigilance. Tu peux seulement rester avec moi."), C("Allenna", "Je vais probablement vérifier la serrure. Une fois. Ensuite, j’essaierai.", "thinking")] },
      amoureux: { label: "Une place hors des rangs", detail: "Lui offrir une tendresse franche qui n’exige ni faiblesse ni obéissance.", effects: { affection: 9, trust: 8, desire: 4 }, lines: [P("Je ne veux pas que tu baisses ta garde pour moi. Je veux une place à côté d’elle."), C("Allenna", "C’est une formulation dangereusement recevable.", "shy")] },
      desir: { label: "Après l’entraînement", detail: "Laisser la précision de ses gestes devenir une proximité choisie et adulte.", effects: { affection: 6, trust: 6, desire: 10 }, lines: [P("Tu peux continuer à tout contrôler, sauf la distance que j’ai envie de réduire."), C("Allenna", "Alors approche et assume le résultat de ta stratégie.", "smirk")] },
    },
    rounds: [
      { prompt: "Allenna veut commencer par un garrot militaire.", detail: "Elle soutient que toute trousse sérieuse doit prévoir le pire.", options: [O("ordinary", "Commencer par les petites blessures réellement probables", 2, C("Allenna", "Une brûlure, une écharde, une migraine. Des urgences assez modestes pour que j’oublie parfois de les soigner.")), O("garrot", "Accepter le garrot, mais au fond de la boîte", 1, N("Elle consent au compromis et vérifie encore deux fois le nœud.")), O("empty", "Retirer tout ce qui rappelle une bataille", 0, C("Allenna", "Ignorer le danger n’a jamais créé la paix."))] },
      { prompt: "Deux fioles presque identiques doivent être étiquetées.", detail: "L’une apaise la douleur ; l’autre réveille un soldat inconscient avec brutalité.", options: [O("symbols", "Dessiner des symboles tactiles impossibles à confondre", 2, N("Allenna teste les marques les yeux fermés, puis ajoute discrètement votre système à ses trousses de campagne.")), O("color", "Utiliser deux couleurs proches", 1, C("Allenna", "Lisible à la lumière. Moins sous la fumée. Acceptable ici.")), O("memory", "Compter sur sa mémoire", 0, C("Allenna", "La compétence ne remplace pas une procédure sûre."))] },
      { prompt: "Il reste un compartiment vide.", detail: "Allenna cherche encore un instrument utile.", options: [O("note", "Y glisser un mot : ‘Demander de l’aide est aussi un soin’", 2, N("Elle relit la phrase, replie le papier et ne le retire pas.")), O("sweets", "Ajouter des confiseries pour les patients difficiles", 1, C("Allenna", "Naïah simulera trois blessures par jour. J’en accepte le risque.")), O("blade", "Ajouter une dernière lame", 0, C("Allenna", "Nous avions pourtant réussi à fabriquer une trousse qui ne préparait aucune guerre."))] },
    ],
    results: { close: [C("Allenna", "Elle suffira aux accidents ordinaires. J’ignorais qu’ils méritaient leur propre préparation.", "thinking")], warm: [C("Allenna", "Garde-la ici. Je vérifierai son contenu lors de ma prochaine… visite non officielle.", "shy")], perfect: [N("Allenna pose la boîte à portée de vos deux mains et laisse sa ceinture d’armes près de la porte."), C("Allenna", "Pour une heure, je vais supposer que la maison sait nous garder. Ne rends pas ce progrès solennel.", "shy")] },
  },
  tia: {
  ...
  draven: {
    character: "draven", title: "Le port dans une bouteille", description: "Partager avec Draven une soirée amicale autour d’une carte, d’un nœud marin et d’un foyer qu’il n’a pas à commander.", gift: "homegift-draven",
    ...
    tones: {
      ...
      amoureux: { label: "Une affection familiale", detail: "Lui dire que sa présence compte comme celle d’un mentor et d’un proche.", effects: { affection: 9, trust: 8 }, lines: [P("Cette porte vous est ouverte comme à quelqu’un de ma famille choisie."), C("Draven", "Je ne prends pas ce mot à la légère. Je ne le refuse pas non plus.", "gruff")] },
      desir: { label: "Une soirée franche", detail: "Transformer la tension en défi de confiance, sans route intime.", effects: { affection: 7, trust: 7 }, lines: [P("Je sais que vous n’êtes pas ici pour une romance. Restez tout de même assez longtemps pour oublier l’heure."), C("Draven", "Enfin une personne capable de distinguer l’intensité de la séduction. Servez le café.", "approving")] },
    },
    rounds: [
...
const RESIDENT_REPLIES: Record<string, Array<[ResidentReply, ResidentReply, ResidentReply]>> = {
  ...
  lineva: [
    ...
    [
      { beat: "Lineva vous tend une minuscule lime comme s’il s’agissait d’une promotion officielle.", line: "Assistant·e provisoire. Si tu casses la quille, je nie t’avoir recruté·e." },
...
export const RESIDENT_MOMENTS: Record<string, HomeMoment[]> = {
  ...
  lineva: [
    moment("lineva", 0, "La ronde du salon", "Lineva vient de vérifier une seconde fois les fenêtres et s’arrête elle-même avant la troisième.", ["Je lui délivre un rapport officiel : le canapé tient toujours.", "Tu peux remarquer le réflexe sans lui obéir.", "Je fais le tour avec elle une dernière fois, puis nous nous asseyons."]),
    moment("lineva", 1, "Un réveil sans cloche", "Lineva s’est levée avant l’aube, certaine d’avoir entendu la relève. La maison demeure silencieuse.", ["Je sonne une cuillère contre une tasse pour annoncer la relève du petit-déjeuner.", "Ton corps pense encore que dormir signifie abandonner quelqu’un.", "Je prépare du café et reste avec elle jusqu’au vrai matin."]),
    moment("lineva", 2, "La maquette avance", "Une nouvelle voile est apparue sur la maquette. Lineva nie y avoir travaillé pendant deux heures.", ["Je réclame le grade officiel d’assistant·e charpentier·e.", "Ce projet avance parce que tu reviens, pas parce qu’une échéance l’exige.", "Je taille silencieusement une petite pièce à côté d’elle."]),
    moment("lineva", 3, "Le rapport brûlé", "Lineva tient un brouillon de rapport domestique intitulé ‘état des provisions’. Elle semble honteuse et amusée.", ["Je l’approuve avec la mention ‘biscuits stratégiquement insuffisants’.", "Tu essaies de rendre le foyer contrôlable avec les outils du commandement.", "Nous gardons la liste des courses et brûlons seulement l’en-tête militaire."]),
  ],
  saidin: [
