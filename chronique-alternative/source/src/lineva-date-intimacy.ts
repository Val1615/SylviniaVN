...
const SEX_BEATS: Record<LinevaMood, Record<PlayerSex, SexBeat>> = {
  joueuse: {
    ...
    homme: {
      ...
      suggestiveClimax: ["Lineva vient s’asseoir sur vous et choisit une cadence qui prolonge le jeu. Votre plaisir monte sous ses mouvements ; le sien se lit dans ses cuisses qui se resserrent et sa main qui revient entre elles."],
      explicitClimax: ["Lineva se place au-dessus de vous. Elle guide le gland contre son entrée humide, descend lentement jusqu’à vous accueillir entièrement puis remonte avec un sourire de défi. Vous soutenez ses hanches sans décider de sa cadence. Lorsqu’elle demande plus vite, vous accompagnez ses mouvements et caressez son clitoris. Elle jouit la première, contractions serrées autour de vous ; son rythme désordonné vous entraîne ensuite jusqu’à l’orgasme, maintenu profondément contre elle."],
  ...
  passionnee: {
    ...
    homme: {
      ...
      suggestiveClimax: ["Vous choisissez ensemble un angle direct mais confortable. Lineva reçoit vos mouvements, les accélère de ses hanches et vient au plaisir sous votre main avant de vous entraîner à sa suite."],
      explicitClimax: ["Vous guidez votre pénis contre l’entrée humide de Lineva. Elle ouvre davantage les jambes et vous attire en elle jusqu’à la profondeur demandée. Vos mouvements deviennent francs, soutenus par ses mains sur vos hanches ; vous caressez son clitoris à chaque poussée. Lineva jouit en vous serrant fortement, son bassin continuant de vous réclamer. Vous maintenez l’angle, accélérez à sa demande puis atteignez l’orgasme profondément en elle, retenu contre son corps jusqu’au dernier spasme."],
