...
export const SUBLOCATIONS: SpotData[] = [
  ...
  // Mir'Aldas
  { id: "miraldas-lanterns", location: "miraldas", name: "Galerie des lanternes", shortName: "Les lanternes", description: "Une terrasse de restauration dans les galeries hautes, à l’écart des instruments de l’observatoire, au-dessus des lumières de la cité.", background: bg("miraldas_observatory"), activities: ["rest"], icon: "✧" },
  ...
  { id: "forthaven-training-yard", location: "forthaven", name: "Cour d’entraînement de la ville haute", shortName: "Cour d’entraînement", description: "Une cour de pierre réparée après l’assaut, bordée de vestiaires et de douches alimentées par les citernes hautes.", background: bg("forthaven"), activities: ["training", "rest"], icon: "⚔" },
  ...
  { id: "akuhn-hidden-basin", location: "akuhn", name: "Bassin chaud sous les arches", shortName: "Bassin caché", description: "Un escalier sans emblème descend vers une vasque chaude où la ville vient respirer loin des fonctions du palais.", background: bg("terrace"), activities: ["rest"], icon: "≋" },
...
const ROUTINES: Record<string, Record<string, RoutineMoment[]>> = {
  ...
  remerii: {
    ...
    miraldas: [
      ...
      moment("miraldas-archives", "choisit un livre après ses recherches"),
      moment("miraldas-observatory", "regarde la cité depuis la terrasse de l’observatoire"),
    ],
  },
  iriana: {
    algratal: [
  ...
  allenna: {
    akuhn: [
      ...
      moment("akuhn-archives", "exécute les décisions d’Amanea au milieu des registres scellés"),
      moment("akuhn-war-room", "commande les défenses selon son propre plan"),
      moment("akuhn-archives", "recoupe les noms et les sceaux rapportés des Serres Rocheuses"),
    ],
    forbidden: [
...
export const ROUTE_SPOTS: Record<string, string> = {
  ...
  "remerii-0": "algratal-streets",
  "remerii-1": "miraldas-atelier",
  "remerii-2": "miraldas-archives",
  "remerii-3": "miraldas-atelier",
  "remerii-4": "miraldas-archives",
  ...
  "lineva-2": "forthaven-ramparts",
  "lineva-3": "forthaven-war-room",
  "lineva-4": "forthaven-ramparts",
  ...
  "allenna-1": "akuhn-archives",
  "allenna-2": "forbidden-threshold",
  "allenna-3": "akuhn-war-room",
  "allenna-4": "akuhn-archives",
...
export const ROUTE_PERIODS: Record<string, PeriodKey[]> = {
  ...
  // Remerii : pas d'heure imposée après le raccord immédiat avec Hylee.
  "remerii-0": ["aube", "matin", "apres-midi", "soirée"],
  "remerii-1": ["aube", "matin", "apres-midi", "soirée"],
  "remerii-2": ["aube", "matin", "apres-midi", "soirée"],
  "remerii-3": ["aube", "matin", "apres-midi", "soirée"],
  "remerii-4": ["aube", "matin", "apres-midi", "soirée"],
  "iriana-0": ["matin"],
  "iriana-1": ["soirée"],
  "iriana-2": ["matin"],
  "iriana-3": ["apres-midi"],
  ...
  "allenna-0": ["aube"],
  "allenna-1": ["matin"],
  "allenna-2": ["apres-midi", "soirée"],
  "allenna-3": ["matin", "apres-midi"],
  "allenna-4": ["matin"],
  "draven-0": ["aube"],
  "draven-1": ["soirée"],
  "draven-2": ["apres-midi"],
