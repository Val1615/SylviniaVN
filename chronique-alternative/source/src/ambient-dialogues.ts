...
export const AMBIENT_LINES: Record<string, AmbientDialogue[]> = {
  ...
  remerii: [
    scene("remerii-lecture", "La page immobile", "Remerii referme son livre. « Si vous me dérangez, faites au moins l’effort d’être intéressant·e. »", [
      R("rem-livre-a", "Lui demander quelle page elle relisait depuis dix minutes.", "audace", "Vous avez choisi la provocation documentée. Acceptable.", { affection: 2 }),
  ...
  lineva: [
    ...
    scene("lineva-reveil", "La première relève", "Lineva ouvre les yeux et tend déjà la main vers ses rapports. Elle s’arrête avant de les toucher. « Dites-moi que le port existe encore sans que j’aie besoin de le vérifier. »", [
      L("lin-reveil-s", "« Il existe. Votre relève aussi. Vous pouvez rester ici. »", "sangFroid", "Alors cinq minutes. …Dix, si vous ne bougez pas.", { trust: 5, affection: 3 }),
      L("lin-reveil-l", "Lui rappeler qui assure précisément chaque poste ce matin.", "lucidite", "Vous avez vérifié pour que je n’aie pas à le faire. C’est une forme de tendresse dangereusement efficace.", { trust: 5, affection: 2 }),
  ...
  saidin: [
    ...
    scene("saidin-pari", "Une prédiction sans enjeu", "Saidin cache ses mains derrière le dos. « Une pierre dans l’une, rien dans l’autre. J’ai promis de ne pas regarder le futur. Ce qui rend ce jeu ridiculement palpitant. »", [
      ...
      S("sai-main-r", "Refuser de sonder la pierre par magie.", "resonance", "Vous pouviez savoir et vous avez choisi de jouer. Je comprends mieux pourquoi votre compagnie m’ancre.", { trust: 4 }),
    ], { mood: "mysterious" }),
    ...
    scene("saidin-ville", "La ville qui n’existe plus", "Saidin dessine une rue que personne ne reconnaît. « Cette ville a existé dans une branche du temps pendant trente-sept ans. Je suis peut-être le dernier à me souvenir de l’odeur de son pain. »", [
      ...
      S("sai-ville-l", "Lui demander le nom du boulanger plutôt que celui du roi.", "lucidite", "Edran. Il brûlait toujours la première fournée. Vous avez choisi exactement la bonne personne à sauver de l’oubli.", { trust: 5, affection: 1 }),
    ], { minStage: 2, mood: "sad" }),
  ...
  bellirith: [
    scene("bellirith-coupe", "La coupe vérifiable", "Bellirith lève une coupe. « Je n’ai rien ajouté à votre verre. Vous pouvez me croire, vérifier ou choisir autre chose. »", [
      ...
      B("bel-coupe-a", "Prendre sa propre coupe. « Je préfère partager votre risque. »", "audace", "Mon verre était parfaitement sûr. Mais votre geste mérite qu’on le célèbre.", { affection: 2, desire: 1 }),
    ], { mood: "seductive" }),
    scene("bellirith-compliment", "Un compliment exact", "Bellirith croise les bras. « Exercice difficile : faites-moi un compliment qui ne concerne ni mon corps, ni mon pouvoir, ni le danger que je représente. »", [
      B("bel-compl-l", "« Vous savez reformuler une limite sans retirer le désir. »", "lucidite", "Précis, observé, et terriblement intime. Vous gagnez.", { trust: 3, affection: 2 }),
      B("bel-compl-s", "Prendre le temps de chercher au lieu de flatter.", "sangFroid", "Vous refusez de remplir le silence avec quelque chose de faux. C’est déjà un compliment.", { trust: 4 }),
      B("bel-compl-a", "« Votre rire, quand vous oubliez de séduire. »", "audace", "Je vais devoir surveiller ce rire. Ou vous donner davantage d’occasions de l’entendre.", { affection: 4 }),
    ], { minStage: 0, mood: "smirk" }),
    scene("bellirith-parfum", "Le parfum inoffensif", "Bellirith vous tend un flacon. « Aucun enchantement. Seulement de la cendre, du velours et une quantité indécente d’orgueil. Vous pouvez vérifier. »", [
      B("bel-parfum-r", "Examiner chaque trace arcanique avant de le sentir.", "resonance", "Rien. Cette absence de magie me rend presque nerveuse. Votre confiance, elle, sera donc réellement gagnée.", { trust: 4 }),
      B("bel-parfum-l", "Lui demander pourquoi elle tient à vous offrir quelque chose de neutre.", "lucidite", "Parce que je veux parfois vous plaire sans pouvoir accuser mes sortilèges du résultat.", { trust: 3, affection: 2 }),
      B("bel-parfum-a", "Lui demander de le porter pour vérifier son effet sur vous.", "audace", "Expérience rigoureusement scientifique, bien sûr. Approchez.", { affection: 3, desire: 2 }),
    ], { minStage: 0, mood: "seductive" }),
    scene("bellirith-danse", "La distance d’une danse", "Bellirith tend la main sans avancer. « C’est vous qui choisirez la distance. Je préviens seulement : je danse très bien à toutes. »", [
      B("bel-danse-s", "Commencer loin et réduire l’espace seulement quand vous le souhaitez.", "sangFroid", "Vous ne confondez pas lenteur et hésitation. J’aime cette assurance.", { trust: 3, desire: 1 }),
      B("bel-danse-a", "L’attirer immédiatement contre vous.", "audace", "Un choix clair. Gardez toutefois une chose en tête : mon prochain mouvement restera une question.", { affection: 3, desire: 3 }),
      B("bel-danse-l", "Lui demander quelle distance elle désire, elle.", "lucidite", "Voilà une question que peu pensent à poser à celle qui semble toujours mener. Plus près, s’il vous plaît.", { trust: 4, affection: 2 }),
    ...
    scene("bellirith-roman", "Le pire roman de séduction", "Bellirith referme un roman avec indignation. « Le héros ignore trois refus, poursuit l’héroïne jusque chez elle et le récit appelle cela de la passion. Même moi, je trouve sa technique embarrassante. »", [
      ...
      B("bel-roman-a", "Lire la scène en remplaçant le héros par une oie très insistante.", "audace", "L’héroïne repousse donc l’oie pour la troisième fois… Voilà, le caractère grotesque devient enfin évident. Continuez.", { affection: 4 }),
    ...
    scene("bellirith-gants", "Le choix d’une main", "Bellirith pose une paire de gants noirs entre vous. « Ils neutralisent presque entièrement mon aura. Avec eux, un contact ne dira rien que nous n’ayons décidé avant. Sans eux, il faudra davantage d’attention. Quelle version préférez-vous aujourd’hui ? »", [
      B("bel-gants-s", "Choisir les gants et lui laisser décider si elle veut ensuite vous toucher.", "sangFroid", "De la clarté sans froideur. Je les mets… et je voudrais tout de même votre main, si l’offre tient toujours.", { trust: 5, affection: 1 }),
      B("bel-gants-l", "Lui demander laquelle des deux versions la met, elle, le plus à l’aise.", "lucidite", "Les gants, aujourd’hui. Merci de vous souvenir que la démone peut aussi avoir besoin d’une limite.", { trust: 5 }),
      B("bel-gants-a", "Choisir sans gants, avec un mot d’arrêt convenu avant le contact.", "audace", "Audacieux·se et préparé·e. Dites le mot une fois pour que nous sachions tous deux qu’il vous appartient.", { trust: 4, desire: 2 }),
    ], { minStage: 0, mood: "seductive" }),
    scene("bellirith-jeu", "Une défaite très personnelle", "Bellirith fixe un plateau de jeu comme s’il l’avait trahie. « Je perds. Sans charme, sans lecture de pensée et contre un jeu destiné aux enfants de huit ans. Vous comprendrez que ma réputation exige votre silence. »", [
      B("bel-jeu-a", "Célébrer votre victoire avec une révérence insupportable.", "audace", "Profitez de cet instant. À la revanche, je serai impitoyable et toujours parfaitement honnête — ce qui est très frustrant.", { affection: 4 }),
      ...
      B("bel-jeu-s", "Proposer une revanche sans lui offrir la victoire.", "sangFroid", "Vous respectez davantage mon désir de jouer que mon besoin de sauver la face. Distribuez les pièces.", { trust: 4 }),
    ...
    scene("bellirith-miroir", "Le miroir trop flatteur", "Le miroir enchanté devant Bellirith affine chacun de ses traits jusqu’à produire une beauté presque irréelle. Elle grimace. « Il me montre ce que la personne qui l’a ensorcelé pensait devoir désirer. J’ai rarement vu un compliment aussi insultant. »", [
      ...
      B("bel-miroir-l", "Demander ce qu’elle-même aime voir lorsqu’elle se regarde.", "lucidite", "Mes yeux quand je viens de rire. Ils cessent alors de surveiller l’effet qu’ils produisent. Faites-moi rire et vérifions.", { trust: 3, affection: 2 }),
      B("bel-miroir-a", "Vous placer devant le miroir pour subir son mauvais goût à sa place.", "audace", "Il vient de vous donner des pommettes héroïques et des cheveux impossibles. Je retire tout ce que j’ai dit : cet objet est hilarant.", { affection: 4 }),
    ...
    scene("bellirith-vetements", "Sans costume de démone", "Bellirith porte une chemise simple et paraît presque contrariée d’être à l’aise. « Pas de bijoux, pas de cuir, pas de mise en scène. J’ai l’impression d’être venue sans armure. »", [
      B("bel-tenue-l", "Ne pas transformer sa simplicité en nouveau fantasme.", "lucidite", "Merci. Vous me regardez sans prétendre que la vulnérabilité me rend plus belle pour votre usage.", { trust: 5 }),
      B("bel-tenue-s", "Lui proposer de repartir si elle ne veut plus être vue ainsi.", "sangFroid", "Et perdre l’occasion de découvrir si je peux rester ? Non. Asseyez-vous près de moi.", { trust: 4, affection: 1 }),
      B("bel-tenue-a", "« L’armure était superbe. La femme dedans m’intéresse davantage. »", "audace", "Une phrase dangereusement réussie. Vous avez le droit d’en être fier·e.", { affection: 4, desire: 1 }),
    ], { minStage: 2, mood: "thoughtful" }),
    scene("bellirith-silence", "Quand le charme se tait", "Bellirith cherche une plaisanterie, puis renonce. « Je ne sais pas toujours quoi offrir quand je ne séduis pas. Le silence me donne l’impression de devenir remplaçable. »", [
      B("bel-silence-s", "Partager le silence sans détourner votre attention.", "sangFroid", "Vous restez vraiment. Sans spectacle, sans récompense. C’est presque insupportablement doux.", { trust: 5, affection: 2 }),
      B("bel-silence-l", "« Votre valeur ne se mesure pas à ce que vous provoquez chez moi. »", "lucidite", "Je voudrais croire cette phrase sans la transformer en nouvelle victoire. Répétez-la plus tard.", { trust: 5 }),
      B("bel-silence-a", "« Vous pourriez m’offrir une opinion terriblement impopulaire. »", "audace", "Très bien : les roses sont surestimées et Valurn triche mal. Vous êtes toujours là ? Excellent.", { affection: 4 }),
    ], { minStage: 2, mood: "cold" }),
    scene("bellirith-jalousie", "Le désir n’est pas un classement", "Bellirith observe la salle avec un calme trop étudié. « Je sais attirer tous les regards. Je ne sais pas quoi faire lorsque le vôtre se pose ailleurs et que je n’ai pas le droit de le rappeler par magie. »", [
      B("bel-jal-l", "« Vous pouvez demander mon attention sans réclamer sa propriété. »", "lucidite", "Regardez-moi, alors. Pas parce que je l’ordonne. Parce que je vous le demande.", { trust: 5, affection: 2 }),
      ...
      B("bel-jal-a", "« Pour l’instant, vous avez réussi à le récupérer sans aucun sort. »", "audace", "Et j’en suis ridiculement fière. Venez plus près avant que je ne gâche ce progrès.", { affection: 4, desire: 3 }),
    ], { minStage: 3, mood: "thoughtful" }),
    scene("bellirith-matin", "La demande du matin", "Bellirith reste au bord du lit, dos tourné. « Je pourrais inventer une raison brillante de prolonger cette matinée. La vérité est moins élégante : je voudrais que vous restiez. »", [
      B("bel-matin-s", "« Je reste. Et vous pourrez me le redemander demain. »", "sangFroid", "Pas d’emprise, pas d’éternité forcée. Seulement une réponse renouvelable. Oui.", { trust: 5, affection: 3 }),
      B("bel-matin-l", "Lui demander ce que “rester” signifie pour elle aujourd’hui.", "lucidite", "Du thé, votre épaule, et aucune obligation de rendre le moment spectaculaire.", { trust: 5, affection: 2 }),
      B("bel-matin-a", "La ramener doucement contre vous. « Demande acceptée. »", "audace", "Clair, enthousiaste et toujours révocable. Vous apprenez très vite.", { affection: 5, desire: 3 }),
    ], { minStage: 4, periods: ["aube", "matin"], mood: "seductive" }),
    scene("bellirith-question", "Cinq minutes de séduction", "Bellirith lève un doigt avant d’approcher. « Question préalable : avez-vous envie que je vous séduise pendant cinq minutes, que je vous parle franchement, ou que je vous laisse tranquille ? Les trois réponses sont intéressantes. »", [
      B("bel-question-s", "Choisir une conversation franche, sans jeu de charme.", "sangFroid", "Alors je rangerai les effets de voix. Franchement : votre présence me plaît, et je n’ai pas besoin de vous désorienter pour que ce soit vrai.", { trust: 4 }),
      ...
      B("bel-question-a", "Accepter les cinq minutes et déclencher vous-même le chronomètre.", "audace", "Une limite mesurable et un public volontaire. Quelle délicieuse pression. Regardez-moi bien.", { affection: 3, desire: 1 }),
    ], { mood: "seductive" }),
    scene("bellirith-mauvaise-blague", "Une blague sans enchantement", "Bellirith retient un sourire. « J’ai préparé une plaisanterie sans charme magique, sans double sens et sans menace voilée. Elle est donc probablement très mauvaise. Souhaitez-vous tout de même l’entendre ? »", [
      ...
      B("bel-blague-l", "Lui demander pourquoi elle tient à la raconter sans aucun pouvoir.", "lucidite", "Parce que si vous riez, je veux savoir que c’est moi — pas mon aura, pas votre vertige. Voilà qui rend la chute soudain terrifiante.", { trust: 4 }),
      B("bel-blague-a", "Proposer une compétition de plaisanteries réellement médiocres.", "audace", "Vous transformez ma vulnérabilité en duel. Parfait. La personne qui fait rire l’autre en dernier gagne le droit de recommencer demain.", { affection: 3 }),
    ], { mood: "smirk" }),
  ],
  amanea: [
