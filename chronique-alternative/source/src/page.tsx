...
type SceneView = {
  ...
  intro: DialogueLine[];
  choices?: ChoiceData[];
  kind: "intro" | "route" | "ambient" | "social" | "date" | "home";
  route?: RouteScene;
  ambientId?: string;
  socialId?: string;
  date?: DateScene;
...
function GameModal({ modal, game, onClose, onActivityClose, buyGift, giveGift, startDate, startDateIntimacy, finishHomeDate, finishHomePairDate, startHomeIntimacy, onIntimacyClose, ritual, onRitualClose, jobState, onJobBegin, onMemoryStart, onJobAction, onJobClose }: { modal: NonNullable<ModalState>; game: GameState; onClose: () => void; onActivityClose: () => void; buyGift: (gift: string) => void; giveGift: (character: string, gift: string) => void; startDate: (dateId: string) => void; startDateIntimacy: (dateId: string) => void; finishHomeDate: (character: string, tone: HomeDateTone, score: number) => void; finishHomePairDate: (pair: string, tone: HomeDateTone, score: number) => void; startHomeIntimacy: (character: string) => void; onIntimacyClose: (completed: boolean, memory?: string) => void; ritual: { sequence: string[]; step: number; phase: string; setPhase: (phase: "memorize" | "play" | "success" | "failure") => void; play: (rune: string) => void }; onRitualClose: () => void; jobState: JobState | null; onJobBegin: () => void; onMemoryStart: () => void; onJobAction: (action: string) => void; onJobClose: () => void }) {
