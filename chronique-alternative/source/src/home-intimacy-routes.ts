  ...
  lineva: [
    {
      ...
      explicit: sexLines(
        ["Lineva vous fait asseoir sur le bureau et explore votre intimité de deux doigts fermes avant de descendre jusqu’à votre perle de plaisir. Sur le lit, elle se place entre vos cuisses avec un coussin sous vos hanches et reprend bouche et doigts jusqu’à votre orgasme.", ["Lineva", "La ville tient. Toi aussi… jusqu’à ce que je te demande le contraire.", "determined"]],
        ["Lineva prend votre sexe dressé dans sa paume et maintient un rythme précis jusqu’à ce que vous la tiriez au bord du bureau. Plus tard, elle vous accueille dans le lit, jambes hautes contre vos flancs, puis vous fait rouler pour chevaucher elle-même la seconde cadence jusqu’à vos orgasmes rapprochés.", ["Lineva", "Pas de manœuvre parfaite. Seulement celle qui nous garde ensemble.", "soft"]],
        ["Lineva suit les réactions de votre corps comme une carte qu’elle refuse de conquérir : mains, bouche, pression des cuisses puis position face à face dans les draps. Vous échangez la conduite à chaque reprise jusqu’à vos orgasmes, puis au calme plus profond qui les suit.", ["Lineva", "Je retiendrai ce chemin. Pas pour le commander, pour savoir revenir.", "soft"]],
      ),
      ellipse: ["Lineva laisse la clé sur le bureau et vous suit dans la chambre sans se retourner. La mer remplit le silence lorsque la porte se ferme, puis accompagne votre plaisir jusqu’à son point culminant."],
      reprise: ["Un bruit du port la réveille. Vous lui montrez la serrure toujours fermée, puis elle revient vers vous avec une lenteur nouvelle et choisit une seconde position où elle peut enfin vous tourner le dos sans crainte.", ["Lineva", "Tu es encore là. Bien. Garde ton bras autour de moi.", "soft"]],
    ...
    },
    {
      ...
      explicit: sexLines(
        ["Lineva fixe l’écharpe autour de votre cuisse ouverte et s’agenouille entre vos jambes. Sa langue se concentre sur votre bouton de rose tandis que deux doigts remplissent votre intimité ; au fauteuil, elle vous installe au-dessus d’elle et vos plis humides se frottent jusqu’à un second orgasme.", ["Lineva", "Tu tiens la boucle. Je m’occupe du reste.", "determined"]],
        ...
        ["Lineva noue l’écharpe de façon à rapprocher vos bassins sans définir lequel doit mener. Vos mains et vos bouches complètent la prise, puis vous changez ensemble de position sur le lit jusqu’à vos orgasmes et au relâchement du tissu sous vos corps.", ["Lineva", "Protection, mobilité, plaisir… Bon sang. Je vais devoir ajouter ce nœud à une liste que personne d’autre ne verra.", "soft"]],
      ),
      ellipse: ["Lineva vérifie une dernière fois le nœud, puis tire l’écharpe et vous entraîne derrière la porte. Le tissu bleu reste seul visible jusqu’à ce que votre plaisir partagé retombe enfin."],
      reprise: ["La boucle s’est défaite pendant votre premier abandon. Vous la renouez ensemble, cette fois autour de vos chevilles mêlées, et reprenez sur le côté dans un rythme calme dicté par la mer.", ["Lineva", "Tu tiens la boucle cette fois. Je veux sentir quand tu me rapproches.", "soft"]],
    ...
    },
    {
      ...
      explicit: sexLines(
        ["Sur le canapé, Lineva glisse sa cuisse contre votre intimité humide et maintient un mouvement de houle pendant que ses doigts trouvent votre point de feu. Au lit, vous vous placez tête-bêche ; vos bouches se répondent jusqu’à deux orgasmes rapprochés par le même roulis.", ["Lineva", "Même cap. Même vague. Tu ne ralentis pas.", "determined"]],
        ["Lineva vous attire debout contre la table, referme sa main sur votre sexe puis se tourne pour vous accueillir entre ses cuisses. Dans la chambre, couchée sur le côté devant vous, elle guide chaque poussée au rythme des vagues jusqu’à vos orgasmes rapprochés.", ["Lineva", "Gardez ce cap… encore trois mouvements… maintenant.", "determined"]],
        ["Vous trouvez ensemble une houle adaptée à vos corps : friction des bassins contre le canapé, mains précises au bord de la table, puis étreinte latérale dans le lit. Lineva maintient le rythme commun jusqu’à ce que vos orgasmes brisent vos souffles sur la même vague.", ["Lineva", "On peut tenir sans rester immobile. Gardez ce rythme.", "soft"]],
      ),
      ellipse: ["La maquette tangue lorsque Lineva vous emporte vers la chambre. Le rideau gonflé par le vent couvre la suite comme une voile, jusqu’à ce que votre plaisir partagé atteigne sa crête."],
      reprise: ["La marée redescend, puis remonte avant l’aube. Vous reprenez sur le côté, plus lentement, Lineva derrière vous et sa main entre vos cuisses pendant que la vraie mer impose sa cadence.", ["Lineva", "Tu bouges avec moi maintenant. Ne change rien.", "soft"]],
  ...
  allenna: [
    {
      ...
      tender: ["Allenna ralentit les prises jusqu'à de longues étreintes. Vos mains apprennent sa poitrine, son ventre et ses hanches sans que la partie disparaisse tout à fait de son sourire."],
      ...
      explicit: sexLines(
        ["Allenna vous ouvre contre les coussins, garde sa bouche sur votre petite amande et fait glisser ses doigts dans votre secret humide. Après votre orgasme, vous échangez les places et lui rendez la même attention jusqu’à son abandon.", ["Allenna", "Première prise réussie. Je réclame la suivante.", "smirk"]],
      ...
      ellipse: ["Les pions restent couchés autour de la carte. Allenna vous entraîne vers la chambre et la partie se poursuit hors du regard du récit."],
      reprise: ["Avant de dormir, elle vous ramène sur le tapis pour une reprise plus lente où chaque position connue reçoit une variation nouvelle."],
      closing: ["Au matin, Allenna pose votre pion et le sien dans la même case sans annoncer de victoire.", ["Allenna", "La variante exige d'autres essais. Je reviendrai préparée.", "smirk"]],
    ...
    },
    {
      ...
      tender: ["Le siège ralentit jusqu'à une suite d'étreintes sur le canapé. Nue contre vous, Allenna rougit encore lorsqu'un regard s'attarde, puis revient elle-même chercher cette attention."],
      suggestive: ["Les prises ouvrent vêtements et distances. Le mot de siège circule avec les mains, les bouches et les bassins jusqu’à ne plus désigner qu’un désir de changer l’angle."],
      explicit: sexLines(
        ["Vous échangez bouche, doigts et frottements sur le tapis puis au lit. Allenna reçoit jusqu’à son orgasme, reprend la position et maintient votre point de feu avec la même constance jusqu’au vôtre.", ["Allenna", "Aucune gagnante. Deux assauts parfaitement exécutés.", "smirk"]],
        ...
        ["Chaque configuration est choisie selon vos corps : toucher, recevoir, pénétrer ou frotter sans rôle fixe. Allenna échange les positions et garde chaque plaisir entier jusqu’à sa conclusion propre.", ["Allenna", "Siège accompli. Demande de reprise en préparation.", "smirk"]],
      ),
      ellipse: ["Le siège vous conduit du tapis au couloir, puis la chambre absorbe le reste de la bataille hors du regard de la chronique."],
    ...
    },
    {
      ...
      tender: ["Vous gardez Allenna contre vous jusqu'à ce que le défi se transforme en baisers lents. Elle ferme les yeux, puis les rouvre pour vérifier seulement que vous la regardez encore."],
      ...
      explicit: sexLines(
        ["Allenna vous fait asseoir dans le fauteuil et entretient votre perle sensible avec sa bouche et ses doigts. Dans le lit, vous lui rendez le plaisir, puis une position en ciseaux prolonge la nuit jusqu’à une seconde jouissance partagée.", ["Allenna", "Le dernier pion est perdu. Je préfère nettement ce qui se passe ici.", "troubled"]],
        ["Allenna prend votre longueur brûlante près du fauteuil, puis vous accueille dans le lit sur le côté, assez proche pour guider chaque profondeur. Elle vient ensuite au-dessus et conduit la reprise jusqu’à vos orgasmes successifs.", ["Allenna", "Aucun vainqueur. Seulement cette cadence et la certitude de pouvoir la changer.", "troubled"]],
        ["Vous choisissez une première stimulation pour votre corps, puis une seconde pour Allenna, sans symétrie imposée. La reprise mêle les deux par les mains, les bouches, le frottement ou la pénétration que vous avez définis ensemble.", ["Allenna", "La manche continue. Personne ne cède encore. Plus près.", "troubled"]],
      ),
      ellipse: ["Le dernier pion tombe sous le lit. Allenna vous rejoint tandis que la chronique abandonne la manche derrière la porte."],
      ...
      closing: ["À l'aube, Allenna retrouve le pion sous le lit et le pose dans votre paume.", ["Allenna", "Gardez-le. La prochaine manche commencera chez vous.", "smirk"]],
...
export const HOME_INTIMACY_APPROACHES: Record<string, IntimacyChoice[]> = {
  ...
  lineva: [
    ...
    { id: "home-lineva-knot", text: "Remplacer sa corde d’exercice par une écharpe qui vous rapproche.", lines: [C("Lineva", "Un bon nœud protège sans étrangler."), P("Montrez-moi."), N("La boucle souple réunit vos poignets et Lineva teste aussitôt la distance d’un baiser.")] },
    { id: "home-lineva-tide", text: "Ouvrir la fenêtre sur la mer et laisser le roulis déplacer vos appuis.", lines: [N("Le vent du port gonfle le rideau."), C("Lineva", "Bougez avec la vague, pas contre elle."), N("Ses mains à votre taille donnent au conseil une signification plus intime.")] },
  ],
  saidin: [
  ...
  allenna: [
    { id: "home-allenna-pion", text: "Glisser le dernier pion sous son col et lui laisser le trouver.", lines: [N("Allenna suit le pion du bout des doigts, puis referme votre main sur l'attache de son uniforme."), C("Allenna", "Manœuvre provocatrice. Je réponds immédiatement.", "smirk")] },
    { id: "home-allenna-fort", text: "Déclarer le canapé forteresse et l'inviter à le prendre.", lines: [C("Allenna", "Défense médiocre, position intéressante."), N("La première prise devient un baiser avant même que le siège commence.")] },
    { id: "home-allenna-last", text: "Miser le choix de la première position sur une dernière manche.", lines: [P("Une partie. Le vainqueur commence."), C("Allenna", "Et la personne qui perd choisit la revanche.", "smirk"), N("Elle pose déjà la carte sur le sol entre vous.")] },
  ],
  draven: [
...
const HOME_CHARACTER_OPENING: Record<string, DialogueLine[]> = {
  ...
  allenna: [C("Allenna", "La carte est encore ouverte et nous n'avons officiellement aucun vainqueur. Je refuse de partir sur une conclusion aussi imprécise.", "smirk")],
...
const HOME_CHARACTER_ENDING: Record<string, DialogueLine[]> = {
  ...
  allenna: [C("Allenna", "Laissez les pions où ils sont. Je veux retrouver exactement ce désordre à la prochaine partie.", "smirk")],
    ...
    sexes.forEach((sex) => {
      ...
      entries.forEach((entry) => {
        ...
        (["tendre", "suggestif", "explicite", "ellipse"] as IntimacyMode[]).forEach((mode) => {
          if (entry.chapters[mode].length < 8 || entry.chapters[mode].some((chapter) => chapter.length === 0)) throw new Error(`${entry.id}/${mode}: au moins huit séquences requises`);
