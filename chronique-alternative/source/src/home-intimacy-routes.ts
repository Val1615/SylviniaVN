  ...
  lineva: [
    ...
    },
    {
      ...
      explicit: sexLines(
        ...
        ["Lineva noue l’écharpe de façon à rapprocher vos bassins sans définir lequel doit mener. Vos mains et vos bouches complètent la prise, puis vous changez ensemble de position sur le lit jusqu’à ce que le tissu se détende sous vos corps comblés.", ["Lineva", "Protection, mobilité, plaisir. Je valide la manœuvre.", "soft"]],
      ),
  ...
  amanea: [
    {
      ...
      threshold: ["Amanea remplit la coupe de basalte et vous la tend avant de boire à son tour. Elle a laissé couronne, escorte et armes au-delà de votre porte.", ["Amanea", "Chez vous, mon titre n’achète aucune obéissance. Ne gaspillez pas ce privilège en devenant timide.", "neutral"]],
      ...
      explicit: sexLines(
        ["Amanea écarte vos cuisses sur la table et fait glisser deux doigts dans votre intimité brûlante, son pouce pressant votre bouton de rose jusqu’au premier orgasme. Au lit, vous venez au-dessus d’elle et guidez son sexe dans votre chaleur ; elle reprend ensuite la cadence en vous tenant par les hanches.", ["Amanea", "Ici, céder n’est pas s’agenouiller. Montrez-moi que vous connaissez la différence.", "troubled"]],
        ["Amanea referme sa main autour de votre membre et vous maintient contre l’âtre jusqu’à ce que vos jambes tremblent. Dans le lit, elle se place au-dessus de vous, vous accueille profondément puis change l’angle avec une puissance mesurée, avant de vous laisser la renverser pour la seconde montée.", ["Amanea", "Votre maison. Votre force. Ne me donnez rien que vous ne puissiez aussi reprendre.", "troubled"]],
    ...
    },
    {
      ...
      closing: ["Le feu redevient ordinaire. Amanea contemple la pierre noircie, satisfaite qu’aucun serviteur ne vienne effacer la trace de votre nuit.", ["Amanea", "Laissez-la. Une maison a le droit de se souvenir autrement qu’un palais.", "soft"]],
    ...
    },
    {
      ...
      explicit: sexLines(
        ...
        ["Amanea s’agenouille dans l’entrée et prend votre membre en bouche avec une patience qui vous fait agripper le mur. Dans la chambre, elle vous accueille face à face, puis vous fait rouler sous elle ; les mouvements deviennent plus puissants avant de ralentir dans une longue position sur le côté.", ["Amanea", "Je ne conquiers rien. Je viens à vous — encore.", "soft"]],
...
export const HOME_INTIMACY_APPROACHES: Record<string, IntimacyChoice[]> = {
  ...
  amanea: [
    { id: "home-amanea-cup", text: "Partager sa coupe sans titre et lui offrir votre siège, jamais votre obéissance.", lines: [C("Amanea", "Chez vous, mon titre ne décide rien."), P("C’est toi que j’ai invitée."), N("Elle goûte cette distinction directement sur votre bouche.")] },
