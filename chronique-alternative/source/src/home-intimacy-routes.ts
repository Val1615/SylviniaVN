  ...
  lineva: [
    ...
    },
    {
      ...
      explicit: sexLines(
        ...
        ["Lineva noue l’écharpe de façon à rapprocher vos bassins sans définir lequel doit mener. Vos mains et vos bouches complètent la prise, puis vous changez ensemble de position sur le lit jusqu’à vos orgasmes et au relâchement du tissu sous vos corps.", ["Lineva", "Appui, mobilité, plaisir… Bon sang. Je vais devoir ajouter ce nœud à une liste que personne d’autre ne verra.", "soft"]],
      ),
