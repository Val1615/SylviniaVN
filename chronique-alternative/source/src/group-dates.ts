...
const PAIR_ROUTE_DATA: Record<string, PairRouteData> = {
  ...
  "group-date-allenna-lineva": {
    ...
    deepening: {
      ...
      second: ["Lineva conduit sans transformer l’intimité en nouvelle épreuve d’endurance. Allenna soutient ses cicatrices, vous soutenez son regard, et la commandante apprend à dire ce qu’elle veut avant que les deux autres ne le devinent à sa place."],
      shared: ["Vous faites tourner la relève : la personne au centre ne protège personne pendant quelques respirations. Allenna et Lineva découvrent que recevoir deux attentions n’est ni une faiblesse ni une dette, puis vous offrent à leur tour la même liberté."],
    },
    escalation: {
      first: ["Allenna ouvre vos vêtements lentement, attentive aux réactions plutôt qu’aux blessures possibles. Lineva défait le baudrier de la soigneuse et transforme chaque vérification clinique en caresse désirée."],
      second: ["Lineva guide vos mains sur ses cicatrices sans les raconter toutes. Allenna embrasse celles qu’elle connaît, puis accepte que vos doigts suivent ses propres marques avec la même délicatesse."],
      shared: ["Les bracelets passent d’un poignet à l’autre avec l’initiative. Deux corps entourent toujours le troisième, mais aucun rôle de gardienne, blessée ou soigneuse ne reste fixé plus longtemps que le désir présent."],
    },
    continuations: {
      first: { tender: ["Allenna vous embrasse avec une concentration bientôt adoucie ; Lineva masse ses épaules et garde votre main contre la sienne. La vigilance devient une chaleur qui circule dans trois directions."], suggestive: ["Allenna suit votre peau tandis que Lineva ouvre sa tenue. La soigneuse perd le fil de son observation lorsque deux bouches viennent répondre à son propre désir."], explicitFlavor: ["Allenna maintient le plaisir que vous lui indiquez pendant que Lineva la stimule et lit chacune de ses réactions. Elle ne cherche plus les signes d’une blessure : elle suit vos frissons, confie ses propres mouvements et accepte enfin d’être soutenue lorsqu’elle jouit."], ellipse: ["Allenna ferme la trousse, Lineva tire le rideau et trois bracelets restent visibles lorsque la chronique quitte l’infirmerie."] },
      second: { tender: ["Lineva vous attire contre sa poitrine ; Allenna embrasse sa tempe et garde vos jambes mêlées. La force ne consiste plus à tenir seule, mais à rester présente dans l’étreinte."], suggestive: ["Lineva descend sur votre peau pendant qu’Allenna défait son baudrier. Ses cicatrices cessent d’être un inventaire de combats et deviennent simplement une carte que deux personnes désirent parcourir."], explicitFlavor: ["Lineva garde sur votre corps le rythme demandé tandis qu’Allenna lui donne du plaisir. Lorsque sa force tremble, elle ne serre pas les dents : elle demande aux deux autres de maintenir leurs gestes et reçoit l’orgasme sans le convertir en nouvelle victoire."], ellipse: ["Lineva pose son épée hors de portée, Allenna sa dernière bande. Le rideau se ferme sur trois corps qui n’ont plus de poste à tenir."] },
      shared: { tender: ["Les places changent au rythme des bracelets. Chacun repose entre deux épaules, offre ensuite ses mains et demeure relié aux deux autres sans devoir mériter cette douceur."], suggestive: ["Les vêtements et les protections rejoignent le sol. Les cicatrices restent visibles, jamais évaluées, tandis que les bouches et les mains suivent trois désirs formulés au présent."], explicitFlavor: ["Vous faites circuler le plaisir sans tour de garde fixe. Allenna, Lineva puis vous choisissez une configuration propre à votre corps ; les deux autres accompagnent la cadence, restent actives après chaque orgasme et modifient entièrement leurs gestes pour la personne suivante."], ellipse: ["Les trois bracelets sont noués au pied de la lampe. La lumière baisse lorsque la relève devient trop intime pour le registre."] },
    },
    aftercare: {
      first: ["Lineva apporte l’eau pendant qu’Allenna vérifie votre confort, puis vous inversez les rôles et lui posez la même question. Elle répond après un silence ; Lineva accueille cette réponse sans plaisanter sur sa difficulté à recevoir."],
      second: ["Allenna refait doucement le bandage de Lineva, non parce qu’il a cédé mais parce que le geste les apaise. Vous leur demandez ce qui a ressemblé à une charge ; chacune répond avant que l’autre ne puisse minimiser."],
