...
export const GROUP_DATES: GroupDateScene[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      C("Allenna", "L’infection n’est pas impressionnée par votre stoïcisme. Asseyez-vous.", "stern"),
