  ...
  lineva: {
    ...
    directions: [
      { id: "lineva-receive", text: "La laisser prendre soin de vous avec toute son intensité.", lines: modes(
        [N("Lineva vous attire contre elle et transforme sa vigilance en attention. Ses gestes restent francs, jamais pressés, comme si elle pouvait enfin protéger quelqu’un sans surveiller un horizon."), C("Lineva", "Pour une fois, laisse-moi m’occuper de ce qui se trouve juste devant moi.", "thoughtful")],
      ...
      { id: "lineva-give", text: "L’obliger doucement à ne plus tenir debout pour tout le monde.", lines: modes(
        [N("Vous la conduisez jusqu’au lit et embrassez une à une les marques de sa fatigue. Lineva résiste au repos par réflexe, puis finit par peser entièrement contre vous."), C("Lineva", "Ne me demande rien pendant une minute. Continue seulement.", "thoughtful")],
      ...
      { id: "lineva-mutual", text: "Faire alterner la force et le repos entre vous.", lines: modes(
        ...
        [N("Vos corps changent de position et d’initiative sans ordre préalable. Lineva aime visiblement vous renverser autant que se laisser ramener contre le lit, sa force devenant un jeu plutôt qu’une obligation."), C("Lineva", "À toi. Profites-en, je reprends la position dans une minute.", "smirk")],
    ...
    afterglow: [N("Lineva s’endort presque, se réveille par réflexe, puis comprend que les cloches du port n’ont pas sonné."), C("Lineva", "Ne bouge pas. Ce n’est pas un ordre… C’est une demande très bien formulée.", "thoughtful")],
  },
