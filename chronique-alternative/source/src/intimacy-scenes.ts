...
export const INTIMACY_PROFILES: Record<string, IntimacyProfile> = {
  ...
  remerii: {
    ...
    approaches: [
      { id: "remerii-improvise", text: "Lui proposer de ne rien prévoir pour les prochaines minutes.", lines: [C("Remerii", "Une méthode dépourvue d’objectif, d’ordre et de critères de réussite. C’est irresponsable."), P("Tu souris."), C("Remerii", "Je constate l’absurdité de la proposition. Rapprochez-vous avant que je retrouve un argument sérieux.", "smirk")] },
  ...
  lineva: {
    ...
    approaches: [
      { id: "lineva-rest", text: "Commencer par délier la tension de ses épaules.", lines: [N("Vos mains se posent au-dessus des marques laissées par l’armure. Lineva expire lentement, comme après une bataille qu’elle n’avait pas admis mener."), C("Lineva", "Plus à gauche. Oui. Si vous répétez que j’ai gémi à cause d’un massage, je vous affecte aux latrines.", "smirk"), N("La menace manque de force. Son sourire, lui, n’en manque pas.")] },
      { id: "lineva-direct", text: "Lui dire clairement que vous la désirez, pas la commandante.", lines: [P("Je ne suis pas venu·e recevoir des ordres. Je suis venu·e pour toi."), C("Lineva", "Bien. Parce que je n’en ai plus à donner ce soir.", "thoughtful"), N("Elle vous attrape par le col et vous embrasse avec une franchise qui rend toute autre explication inutile.")] },
      { id: "lineva-wall", text: "L’embrasser contre la porte avant qu’elle ne rouvre le coffre.", lines: [N("Sa main avait déjà dérivé vers la clé. Vous l’interceptez par un baiser et Lineva heurte doucement la porte dans son recul."), C("Lineva", "Décision tactiquement discutable."), P("Tu comptes me sanctionner ?"), C("Lineva", "Après une évaluation approfondie.", "smirk") ] },
    ],
    directions: [
      { id: "lineva-receive", text: "La laisser prendre soin de vous avec toute son intensité.", lines: modes(
        [N("Lineva vous attire contre elle et transforme sa vigilance en attention. Ses gestes restent francs, jamais pressés, comme si elle pouvait enfin protéger quelqu’un sans surveiller un horizon."), C("Lineva", "Pour une fois, laissez-moi m’occuper de ce qui se trouve juste devant moi.", "thoughtful")],
        ...
        [receivedBody("femme", "Lineva"), N("Lineva soutient le rythme avec une détermination implacable jusqu’à ce que vous jouissiez contre elle. Votre corps tremble encore lorsqu’elle remonte vous embrasser, le regard plus doux que triomphant."), C("Lineva", "Objectif atteint. Et non, je ne rédigerai aucun compte rendu.", "smirk")],
        [N("Lineva souffle la lampe et vous attire contre elle. Les feux du port restent seuls témoins de la nuit qui continue.")],
      ) },
      { id: "lineva-give", text: "L’obliger doucement à ne plus tenir debout pour tout le monde.", lines: modes(
        [N("Vous la conduisez jusqu’au lit et embrassez une à une les marques de sa fatigue. Lineva résiste au repos par réflexe, puis finit par peser entièrement contre vous."), C("Lineva", "Ne me demandez rien pendant une minute. Continuez seulement.", "thoughtful")],
        ...
        [targetBody("lineva"), N("Vous la faites jouir jusqu’à ce que ses jambes tremblent et que sa main cherche la vôtre au lieu de la garde de son arme. Le cri qu’elle retient devient votre prénom contre les draps."), C("Lineva", "Forthaven tient. Je peux… rester allongée encore cinq minutes.", "thoughtful")],
      ...
      { id: "lineva-mutual", text: "Faire alterner la force et le repos entre vous.", lines: modes(
        [N("Vous vous soutenez tour à tour, un baiser offert quand l’autre se tend, une étreinte quand la fatigue revient. Lineva découvre un équilibre qui ne ressemble ni à une garde ni à une reddition."), C("Lineva", "Une relève à deux. Ça, je sais faire.", "thoughtful")],
        [N("Vos corps changent de position et d’initiative sans ordre préalable. Lineva aime visiblement vous renverser autant que se laisser ramener contre le lit, sa force devenant un jeu plutôt qu’une obligation."), C("Lineva", "À vous. Profitez-en, je reprends la position dans une minute.", "smirk")],
    ...
    afterglow: [N("Lineva s’endort presque, se réveille par réflexe, puis comprend que les cloches du port n’ont pas sonné."), C("Lineva", "Ne bougez pas. Ce n’est pas un ordre… C’est une demande très bien formulée.", "thoughtful")],
  },
  ...
  bellirith: {
    opening: [C("Bellirith", "Le charme est éteint. Je n’ai donc plus d’excuse si vous me trouvez encore séduisante."), N("Elle retire son dernier bijou enchanté. Son sourire demeure, mais ses mains n’ont plus cette immobilité parfaite qui faisait de chaque geste une mise en scène.")],
    approaches: [
      { id: "bellirith-truth", text: "Lui dire ce que vous désirez chez elle quand aucun sort ne parle.", lines: [P("Ta façon de sourire quand tu n’es plus certaine de l’effet produit."), N("Le sourire en question disparaît, remplacé par une émotion beaucoup plus nue."), C("Bellirith", "Vous choisissez toujours l’endroit exact où je ne suis pas préparée.", "thoughtful"), N("Elle vient vous embrasser sans reprendre son rôle.")] },
      { id: "bellirith-game", text: "Lui proposer un jeu où toute séduction doit rester parfaitement ordinaire.", lines: [C("Bellirith", "Une contrainte délicieuse. Dois-je également renoncer à mon talent naturel ?"), P("Seulement à la magie."), N("Elle défait lentement un bouton de sa chemise."), C("Bellirith", "Alors vous êtes perdu·e.", "seductive") ] },
    ...
    directions: [
      ...
      { id: "bellirith-give", text: "La dépouiller de son spectacle jusqu’à ne garder que ses réactions.", lines: modes(
        [N("Vous effacez son sourire étudié sous une suite de baisers imprévisibles. Bellirith finit par cacher son visage contre votre cou, vaincue par une douceur qu’elle ne peut pas retourner en arme."), C("Bellirith", "Ne vous habituez pas à me voir aussi désarmée.", "thoughtful")],
        [N("Vous ouvrez sa chemise et faites de chaque partie de sa peau un endroit où sa maîtrise peut céder. Ses mots restent provocateurs, mais ses hanches et son souffle vous livrent une vérité plus immédiate."), C("Bellirith", "Plus bas. Puis je vous montrerai que je reste dangereuse sans aucun sort.", "seductive")],
        [targetBody("bellirith"), N("Bellirith gémit sans mise en scène lorsque votre bouche la conduit jusqu’à l’orgasme. Ses doigts se crispent dans vos cheveux ; le plaisir la traverse avec une sincérité qui laisse son regard humide et son sourire absent."), C("Bellirith", "Ne dites rien de gentil tout de suite. Je pourrais vous croire.", "thoughtful")],
      ...
      { id: "bellirith-mutual", text: "Faire de la séduction un duel où chacun·e peut renverser l’autre.", lines: modes(
        [N("Vous échangez provocations et baisers jusqu’à ce que personne ne sache qui mène encore. Bellirith rit lorsqu’une de vos caresses lui fait oublier la réplique qu’elle préparait."), C("Bellirith", "Vous devenez dangereusement compétent·e.", "smirk")],
    ...
    afterglow: [N("Bellirith reste près de vous sans chercher à rendre la pose séduisante. Ses doigts trouvent les vôtres sous le drap."), C("Bellirith", "Vous pouvez continuer à me désirer. J’aimerais simplement que, parfois, vous restiez aussi quand je ne fais rien pour le mériter.", "thoughtful")],
  },
